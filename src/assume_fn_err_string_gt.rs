/// Assume one function ok() is greater than anoter.
///
...
/// # fn main() {
/// let x = assume_fn_err_string_gt!(f, 2, 1);
...
/// fn f(i: i32) -> Result<bool, String> { Err(format!("{:?}", i)) }
/// # fn main() {
/// let x = assume_fn_err_string_gt!(f, 1, 2);
/// assert_eq!(x.unwrap_err(), "assumption failed: `assume_fn_err_string_gt!(fn, left, right)`\n  left input: `1`,\n right input: `2`,\n  left output: `\"1\"`,\n right output: `\"2\"`".to_string());
/// # }
/// ```
///
