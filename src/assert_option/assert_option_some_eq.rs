                        ...
                        if a_inner == b_inner {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_option_some_eq.html\n",
                                    " a label: `{}`,\n",
                                    " a debug: `{:?}`,\n",
                                    " a inner: `{:?}`,\n",
                                    " b label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_option_some_eq!(a, b)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_option_some_eq.html
/// //  a label: `a`,
/// //  a debug: `Some(1)`,
/// //  a inner: `1`,
/// //  b label: `b`,
