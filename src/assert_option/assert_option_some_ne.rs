                        ...
                        if a_inner != b_inner {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_option_some_ne.html\n",
                                    " a label: `{}`,\n",
                                    " a debug: `{:?}`,\n",
                                    " a inner: `{:?}`,\n",
                                    " b label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_option_some_ne!(a, b)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_option_some_ne.html
/// //  a label: `a`,
/// //  a debug: `Some(1)`,
/// //  b label: `b`,
/// //  b debug: `Some(1)`,
...
macro_rules! assert_option_some_ne {
    ($a:expr, $b:expr $(,)?) => {{
        match $crate::assert_option_some_ne_as_result!($a, $b) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    }};
