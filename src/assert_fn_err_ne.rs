...
///
/// # fn main() {
/// assert_fn_err_ne!(example_digit_to_string, 10, 20);
/// //-> ()
///
/// # let result = panic::catch_unwind(|| {
/// assert_fn_err_ne!(example_digit_to_string, 10, 10);
/// //-> panic!("…")
/// // assertion failed: `assert_fn_err_ne!(function, left, right)`
...
/// # let expect = "assertion failed: `assert_fn_err_ne!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `10`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"10 is out of range\"`";
...
macro_rules! assert_fn_err_ne {
    ($function:path, $a:expr, $b:expr $(,)?) => ({
        ...
        if !a_is_err || !b_is_err {
            panic!("assertion failed: `assert_fn_err_ne!(function, left, right)`\n     function: `{:?}`,\n   left input: `{:?}`,\n  right input: `{:?}`,\n  left is err: `{:?}`,\n right is err: `{:?}`", stringify!($function), $a, $b, a_is_err, b_is_err);
        } else {
...
mod tests {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_err_ne!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `10`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"10 is out of range\"`")]
