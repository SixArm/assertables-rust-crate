...
/// //-> panic!("…")
/// // assertion failed: `assert_f_err_lt!(function, left, right)`
...
mod tests {
    ...
    #[test]
    fn test_assert_f_err_lt_x_arity_2_lt_success() {
        let a = 10;
        let b = 20;
        let x = assert_f_err_lt!(example_digit_to_string, a, b);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_err_lt!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `10`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"10 is out of range\"`")]
    fn test_assert_f_err_lt_x_arity_2_eq_failure() {
        let a = 10;
        let b = 10;
        let _x = assert_f_err_lt!(example_digit_to_string, a, b);
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_err_lt!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `20`,\n  right input: `10`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"20 is out of range\"`,\n right output: `\"10 is out of range\"`")]
    fn test_assert_f_err_lt_x_arity_2_gt_failure() {
        let a = 20;
        let b = 10;
        let _x = assert_f_err_lt!(example_digit_to_string, a, b);
    }
    ...
    #[test]
    fn test_assert_f_err_lt_x_arity_3_lt_success() {
        let a = 10;
        let b = 20;
        let x = assert_f_err_lt!(example_digit_to_string, a, b, "message");
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_f_err_lt_x_arity_3_eq_failure() {
        let a = 10;
        let b = 10;
        let _x = assert_f_err_lt!(example_digit_to_string, a, b, "message");
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_f_err_lt_x_arity_3_gt_failure() {
        let a = 20;
        let b = 10;
        let _x = assert_f_err_lt!(example_digit_to_string, a, b, "message");
    }
