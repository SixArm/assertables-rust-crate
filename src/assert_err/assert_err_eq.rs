                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.4.0/assertables/macro.assert_err_eq.html\n",
                                " a label: `{}`,\n",
                                " a debug: `{:?}`,\n",
                                " a inner: `{:?}`,\n",
                                " b label: `{}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_err_eq_as_result_success() {
        let a: Result<i8, i8> = Err(1);
        let b: Result<i8, i8> = Err(1);
    ...
    #[test]
    fn test_assert_err_eq_as_result_failure_because_not_err() {
