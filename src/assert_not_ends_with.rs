...
///
/// This macro provides the same statements as [`assert_not_ends_with`],
...
/// # Module macros
///
/// * [`assert_not_ends_with`](macro.assert_not_ends_with.html)
/// * [`assert_not_ends_with_as_result`](macro.assert_not_ends_with_as_result.html)
/// * [`debug_assert_not_ends_with`](macro.debug_assert_not_ends_with.html)
///
#[macro_export]
...
mod tests {
    ...
    #[test]
    fn test_assert_not_ends_with_as_result_x_success() {
        let a = "foogoo";
        let b = "foo";
        let x = assert_not_ends_with_as_result!(a, b);
        assert_eq!(x.unwrap(), ());
    }
...
macro_rules! assert_not_ends_with {
    ($a:expr, $b:expr $(,)?) => ({
        match assert_not_ends_with_as_result!($a, $b) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
