...
mod tests {
    ...
    #[test]
    fn test_assert_set_joint_as_result_x_success() {
        let a = [1, 2];
        let b = [2, 3];
    ...
    #[test]
    fn test_assert_set_joint_as_result_x_failure() {
        let a = [1, 2];
        let b = [3, 4];
        let result = assert_set_joint_as_result!(&a, &b);
...
/// # });
/// // assertion failed: `assert_set_joint!(a_collection, b_collection)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_set_joint.html
/// //  a label: `&a`,
/// //  a debug: `[1, 2]`,
/// //  b label: `&b`,
/// //  b debug: `[3, 4]`,
