...
//! # Module macros
//!
//! * [`assert_abs_diff_le`](macro@crate::assert_abs_diff_le)
//! * [`assert_abs_diff_le_as_result`](macro@crate::assert_abs_diff_le_as_result)
//! * [`debug_assert_abs_diff_le`](macro@crate::debug_assert_abs_diff_le)
                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.5.0/assertables/macro.assert_abs_diff_le.html\n",
                                "       a label: `{}`,\n",
                                "       a debug: `{:?}`,\n",
                                "       b label: `{}`,\n",
                                "       b debug: `{:?}`,\n",
...
#[cfg(test)]
mod test_assert_abs_diff_le_as_result {
    ...
    fn lt() {
        ...
        let b = 13;
        let delta = 4;
        let actual = assert_abs_diff_le_as_result!(a, b, delta);
...
mod test_assert_abs_diff_le {
    ...
    fn lt() {
        ...
        let b = 13;
        let delta = 4;
        let actual = assert_abs_diff_le!(a, b, delta);
        assert_eq!(actual, 3);
    }
    ...
    fn gt() {
        let result = panic::catch_unwind(|| {
            ...
            let b = 13;
            let delta = 2;
            let _result = assert_abs_diff_le!(a, b, delta);
        });
        let message = concat!(
            "assertion failed: `assert_abs_diff_le!(a, b, delta)`\n",
            "https://docs.rs/assertables/9.5.0/assertables/macro.assert_abs_diff_le.html\n",
...
/// | a - b | ≤ c
///
/// This macro provides the same statements as [`assert_abs_diff_le`](macro.assert_abs_diff_le.html),
