                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.5.0/assertables/macro.assert_abs_diff_ge_x.html\n",
                                "       a label: `{}`,\n",
                                "       a debug: `{:?}`,\n",
                                "       b label: `{}`,\n",
                                "       b debug: `{:?}`,\n",
...
#[cfg(test)]
mod test_assert_abs_diff_ge_x_as_reasult {
    ...
    fn eq() {
        ...
        let b = 13;
        let x = 3;
        let actual: Result<i32, String> = assert_abs_diff_ge_x_as_result!(a, b, x);
        assert_eq!(actual.unwrap(), 3);
    }
