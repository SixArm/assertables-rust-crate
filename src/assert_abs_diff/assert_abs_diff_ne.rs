...
//! # Module macros
//!
//! * [`assert_abs_diff_ne`](macro@crate::assert_abs_diff_ne)
//! * [`assert_abs_diff_ne_as_result`](macro@crate::assert_abs_diff_ne_as_result)
//! * [`debug_assert_abs_diff_ne`](macro@crate::debug_assert_abs_diff_ne)
                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.1.0/assertables/macro.assert_abs_diff_ne.html\n",
                                "       a label: `{}`,\n",
                                "       a debug: `{:?}`,\n",
                                "       b label: `{}`,\n",
                                "       b debug: `{:?}`,\n",
...
/// | a - b | ≠ c
///
/// This macro provides the same statements as [`assert_abs_diff_ne`](macro.assert_abs_diff_ne.html),
