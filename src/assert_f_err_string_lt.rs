...
/// }
/// # fn main() {
/// assert_f_err_string_lt!(digit_to_string, 10, 20);
/// //-> ()
///
/// # let result = panic::catch_unwind(|| {
/// assert_f_err_string_lt!(digit_to_string, 20, 10);
/// //-> panic!("…")
...
mod tests {
    ...
    fn test_assert_f_err_string_lt_x_arity_2_lt_success() {
        let a = 10;
        let b = 20;
        let x = assert_f_err_string_lt!(digit_to_string, a, b);
        assert_eq!(x, ());
    }
    ...
    fn test_assert_f_err_string_lt_x_arity_2_eq_failure() {
        let a = 10;
        let b = 10;
        let _x = assert_f_err_string_lt!(digit_to_string, a, b);
    }
    ...
    fn test_assert_f_err_string_lt_x_arity_3_lt_success() {
        let a = 10;
        let b = 20;
        let x = assert_f_err_string_lt!(digit_to_string, a, b, "message");
        assert_eq!(x, ());
    }
    ...
    fn test_assert_f_err_string_lt_x_arity_3_eq_failure() {
        let a = 10;
        let b = 10;
        let _x = assert_f_err_string_lt!(digit_to_string, a, b, "message");
    }
