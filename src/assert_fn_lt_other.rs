...
mod test_x_panic {
    ...
    #[test]
    fn test_assert_fn_lt_other_x_arity_2_lt_success() {
        let a: i32 = 1;
        let b: i32 = -2;
        let x = assert_fn_lt_other!(i32::abs, a, b);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_lt_other!(function, left_input, right_input)`\n    function name: `i32::abs`,\n  left input name: `a`,\n right input name: `b`,\n       left input: `1`,\n      right input: `-1`,\n      left output: `1`,\n     right output: `1`")]
    fn test_assert_fn_lt_other_x_arity_2_eq_failure() {
        let a: i32 = 1;
        let b: i32 = -1;
        let _x = assert_fn_lt_other!(i32::abs, a, b);
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_lt_other!(function, left_input, right_input)`\n    function name: `i32::abs`,\n  left input name: `a`,\n right input name: `b`,\n       left input: `-2`,\n      right input: `1`,\n      left output: `2`,\n     right output: `1`")]
    fn test_assert_fn_lt_other_x_arity_2_gt_failure() {
        let a: i32 = -2;
        let b: i32 = 1;
        let _x = assert_fn_lt_other!(i32::abs, a, b);
    }
    ...
    #[test]
    fn test_assert_fn_lt_other_x_arity_3_lt_success() {
        let a: i32 = 1;
        let b: i32 = -2;
        let x = assert_fn_lt_other!(i32::abs, a, b, "message");
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_fn_lt_other_x_arity_3_eq_failure() {
        let a: i32 = 1;
        let b: i32 = -1;
        let _x = assert_fn_lt_other!(i32::abs, a, b, "message");
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_fn_lt_other_x_arity_3_gt_failure() {
        let a: i32 = -2;
        let b: i32 = 1;
        let _x = assert_fn_lt_other!(i32::abs, a, b, "message");
    }
