...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_lt_other_as_result_x_success_because_lt() {
        let a: i32 = 1;
        let b: i32 = -2;
    ...
    #[test]
    fn test_assert_fn_lt_other_as_result_x_failure_because_eq() {
        let a: i32 = 1;
        let b: i32 = -1;
        let x = assert_fn_lt_other_as_result!(i32::abs, a, b);
        assert!(x.is_err());
    ...
    #[test]
    fn test_assert_fn_lt_other_as_result_x_failure_because_gt() {
        let a: i32 = -2;
        let b: i32 = 1;
        let x = assert_fn_lt_other_as_result!(i32::abs, a, b);
        assert!(x.is_err());
