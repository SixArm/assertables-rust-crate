...
/// # Module macros
///
/// * [`assert_program_args_stderr_eq_expr`](macro.assert_program_args_stderr_eq_expr.html)
/// * [`assert_program_args_stderr_eq_expr_as_result`](macro.assert_program_args_stderr_eq_expr_as_result.html)
/// * [`debug_assert_program_args_stderr_eq_expr`](macro.debug_assert_program_args_stderr_eq_expr.html)
///
#[macro_export]
...
macro_rules! assert_program_args_stderr_eq_expr {
    ($a_program:expr, $a_args:expr, $b_expr:expr $(,)?) => ({
        match assert_program_args_stderr_eq_expr_as_result!($a_program, $a_args, $b_expr) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
/// Assert a command (built with program and args) stderr string is equal to an expression.
///
/// This macro provides the same statements as [`assert_program_args_stderr_eq_expr`],
