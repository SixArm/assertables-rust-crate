                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.1.0/assertables/macro.assert_ok_eq_x.html\n",
                                        " a label: `{}`,\n",
                                        " a debug: `{:?}`,\n",
                                        " a inner: `{:?}`,\n",
                                        " b label: `{}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_ok_eq_x_expr_as_result_x_success() {
        let a: Result<i8, i8> = Ok(1);
        let b: i8 = 1;
    ...
    #[test]
    fn test_assert_ok_eq_x_expr_as_result_x_failure_because_not_ok() {
