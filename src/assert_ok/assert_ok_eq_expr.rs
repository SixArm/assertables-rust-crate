                        ...
                        if a_inner == b {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_ok_eq_expr.html\n",
                                    " a label: `{}`,\n",
                                    " a debug: `{:?}`,\n",
                                    " a inner: `{:?}`,\n",
                                    " b label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_ok_eq_expr!(a, b)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_ok_eq_expr.html
/// //  a label: `a`,
/// //  a debug: `Ok(1)`,
/// //  a inner: `1`,
/// //  b label: `b`,
