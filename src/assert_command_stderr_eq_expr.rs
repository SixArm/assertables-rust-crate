...
/// # Module macros
///
/// * [`assert_command_stderr_eq_expr`](macro.assert_command_stderr_eq_expr.html)
/// * [`assert_command_stderr_eq_expr_as_result`](macro.assert_command_stderr_eq_expr_as_result.html)
/// * [`debug_assert_command_stderr_eq_expr`](macro.debug_assert_command_stderr_eq_expr.html)
///
#[macro_export]
...
mod tests {
    ...
    fn test_assert_command_stderr_eq_expr_as_result_x_success() {
        ...
        let x = assert_command_stderr_eq_expr_as_result!(a, b);
        assert_eq!(x.unwrap(), ());
    }
...
/// Assert a command stderr string is equal to an expression.
///
/// This macro provides the same statements as [`assert_command_stderr_eq_expr`],
