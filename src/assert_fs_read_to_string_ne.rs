...
//! # Module macros
//!
//! * [`assert_fs_read_to_string_ne`](macro.assert_fs_read_to_string_ne.html)
//! * [`assert_fs_read_to_string_ne_as_result`](macro.assert_fs_read_to_string_ne_as_result.html)
//! * [`debug_assert_fs_read_to_string_ne`](macro.debug_assert_fs_read_to_string_ne.html)
...
mod tests {
    ...
    fn test_read_to_string_ne_as_result_x_success() {
        ...
        let x = assert_fs_read_to_string_ne_as_result!(&a, &b);
        assert_eq!(x, Ok(()));
    }

    #[test]
    fn test_read_to_string_ne_as_result_x_failure() {
        let a = DIR.join("alfa.txt");
...
macro_rules! assert_fs_read_to_string_ne {
    ($a_path:expr, $b_path:expr $(,)?) => ({
        match assert_fs_read_to_string_ne_as_result!($a_path, $b_path) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
///
#[macro_export]
macro_rules! debug_read_to_string_ne {
    ($($arg:tt)*) => {
