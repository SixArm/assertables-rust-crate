...
/// assert_eq!(x.unwrap(), ());
///
/// let x = assertable_f_err_string_le!(example_digit_to_string, 20, 10);
/// //-> Err("…")
...
mod tests {
    ...
    fn test_assertable_f_err_string_le_x_arity_2_lt_success() {
        let a = 10;
        let b = 20;
        let x = assertable_f_err_string_le!(example_digit_to_string, a, b);
        assert_eq!(
            x.unwrap(),
            ()
        );
    ...
    fn test_assertable_f_err_string_le_x_arity_3_lt_success() {
        let a = 10;
        let b = 20;
        let x = assertable_f_err_string_le!(example_digit_to_string, a, b, "message");
        assert_eq!(
            x.unwrap(),
            ()
        );
