...
/// //-> Err("…")
/// // assertable failed: `assertable_f_err_string_gt!(fn, left, right)`
/// //    left input: `1`,
/// //   right input: `2`,
/// //   left output: `\"1\"`,
/// //  right output: `\"2\"`
/// assert_eq!(x.unwrap_err(), "assertable failed: `assertable_f_err_string_gt!(fn, left, right)`\n   left input: `1`,\n  right input: `2`,\n  left output: `\"1\"`,\n right output: `\"2\"`".to_string());
/// # }
/// ```
///
...
macro_rules! assertable_f_err_string_gt {
    ($function:path, $left:expr, $right:expr $(,)?) => ({
        ...
        if !left.is_err() || !right.is_err() {
            Err(format!("assertable failed: `assertable_f_err_string_gt!(fn, left, right)`\n   left input: `{:?}`,\n  right input: `{:?}`\n  left output is_err(): `{:?}`,\n right output is_err(): `{:?}`", $left, $right, left.is_err(), right.is_err()))
        } else {
