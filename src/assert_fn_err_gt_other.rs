...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_err_gt_other_as_result_x_arity_2_gt_success() {
        let a: i32 = 20;
        let b: i32 = 10;
        let x = assert_fn_err_gt_other_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_err_gt_other_as_result_x_arity_2_eq_failure() {
        let a: i32 = 10;
        let b: i32 = 10;
        let x = assert_fn_err_gt_other_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_err_gt_other_as_result_x_arity_2_lt_failure() {
        let a: i32 = 10;
        let b: i32 = 20;
        let x = assert_fn_err_gt_other_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_err_gt_other_as_result_x_arity_3_gt_success() {
        let a: i32 = 20;
        let b: i32 = 10;
        let x = assert_fn_err_gt_other_as_result!(example_digit_to_string, a, b, "message");
        assert_eq!(
            x.unwrap(),
            ()
        );
    ...
    #[test]
    fn test_assert_fn_err_gt_other_as_result_x_arity_3_eq_failure() {
        let a: i32 = 10;
        let b: i32 = 10;
        let x = assert_fn_err_gt_other_as_result!(example_digit_to_string, a, b, "message");
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_err_gt_other_as_result_x_arity_3_lt_failure() {
        let a: i32 = 10;
        let b: i32 = 20;
        let x = assert_fn_err_gt_other_as_result!(example_digit_to_string, a, b, "message");
        assert_eq!(
