            ...
            Err(
                format!(
                    concat!(
                        ...
                        "https://docs.rs/assertables/9.4.0/assertables/macro.assert_not_matches.html\n",
                        " args: `{}`",
                    ),
                    stringify!($($arg)*)
                )
...
mod tests {
    ...
    #[test]
    fn test_assert_not_matches_as_result_x_char_x_success() {
        let a = 'a';
        let result = assert_not_matches_as_result!(a, 'b'..='z');
        assert_eq!(result, Ok(()));
    }
    ...
    #[test]
    fn test_assert_not_matches_as_result_x_some_x_success() {
        let a = Some(2);
