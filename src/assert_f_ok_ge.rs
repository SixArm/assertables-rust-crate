...
///
/// # fn main() {
/// assert_f_ok_ge!(i32::from_str, "2", "1");
/// //-> ()
///
/// # let result = panic::catch_unwind(|| {
/// assert_f_ok_ge!(i32::from_str, "1", "2");
/// //-> panic!("…")
/// // assertion failed: `assert_f_ok_ge!(fn, left, right)`
/// //    left input: `\"1\"`,
/// //   right input: `\"2\"`,
/// //   left output: `1`,
/// //  right output: `2`
...
/// # let expect = "assertion failed: `assert_f_ok_ge!(fn, left, right)`\n   left input: `\"1\"`,\n  right input: `\"2\"`,\n  left output: `1`,\n right output: `2`";
...
mod tests {
    ...
    fn test_assert_f_ok_ge_x_arity_2_gt_success() {
        let a = "2";
        let b = "1";
        let x = assert_f_ok_ge!(i32::from_str, a, b);
        assert_eq!(x, ());
    }
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_ok_ge!(fn, left, right)`\n   left input: `\"1\"`,\n  right input: `\"2\"`,\n  left output: `1`,\n right output: `2`")]
    fn test_assert_f_ok_ge_x_arity_2_lt_failure() {
        let a = "1";
        let b = "2";
        let _x = assert_f_ok_ge!(i32::from_str, a, b);
    }
    ...
    fn test_assert_f_ok_ge_x_arity_3_gt_success_gt() {
        let a = "2";
        let b = "1";
        let x = assert_f_ok_ge!(i32::from_str, a, b, "message");
        assert_eq!(x, ());
    }
    ...
    fn test_assert_f_ok_ge_x_arity_3_failure() {
        let a = "1";
        let b = "2";
        let _x = assert_f_ok_ge!(i32::from_str, a, b, "message");
    }
