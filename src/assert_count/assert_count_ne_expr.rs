                ...
                if a_count != $b {
                    ...
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/9.0.0/assertables/macro.assert_count_ne_expr.html\n",
                            " a label: `{}`,\n",
                            " a debug: `{:?}`,\n",
                            " a.count(): `{:?}`,\n",
                            " b label: `{}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_count_ne_expr_as_result_x_success_because_lt() {
        let a = "x".chars();
        let b = 2;
    ...
    #[test]
    fn test_assert_count_ne_expr_as_result_x_success_because_gt() {
        let a = "xx".chars();
        let b = 1;
        let result = assert_count_ne_expr_as_result!(a, b);
