...
/// //-> Err
/// // assertable failed: `assertable_fn_eq!(fn, left, right)`
/// //    left input: `1`,
/// //   right input: `-2`,
/// //   left output: `1`,
/// //  right output: `2`
/// assert_eq!(x.unwrap_err(), "assertable failed: `assertable_fn_eq!(fn, left, right)`\n   left input: `1`,\n  right input: `-2`,\n  left output: `1`,\n right output: `2`".to_string());
/// # }
/// ```
///
...
macro_rules! assertable_fn_eq {
    ($function:path, $left:expr, $right:expr $(,)?) => ({
        ...
        if (left == right) {
            ...
            Err(format!("assertable failed: `assertable_fn_eq!(fn, left, right)`\n   left input: `{:?}`,\n  right input: `{:?}`,\n  left output: `{:?}`,\n right output: `{:?}`", $left, $right, left, right))
        }
    });
