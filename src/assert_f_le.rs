...
/// //-> panic!("…")
/// // assertion failed: `assert_f_le!(fn, left, right)`
/// //    left input: `-2`,
/// //   right input: `1`,
/// //   left output: `2`,
/// //  right output: `1`
...
/// # let expect = "assertion failed: `assert_f_le!(fn, left, right)`\n   left input: `-2`,\n  right input: `1`,\n  left output: `2`,\n right output: `1`";
...
macro_rules! assert_f_le {
    ($function:path, $left:expr, $right:expr $(,)?) => ({
        ...
        if (left <= right) {
            ...
            panic!("assertion failed: `assert_f_le!(fn, left, right)`\n   left input: `{:?}`,\n  right input: `{:?}`,\n  left output: `{:?}`,\n right output: `{:?}`", $left, $right, left, right);
        }
    });
...
mod tests {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_le!(fn, left, right)`\n   left input: `-2`,\n  right input: `1`,\n  left output: `2`,\n right output: `1`")]
