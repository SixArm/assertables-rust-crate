...
/// let expect = concat!(
///     "assertion failed: `assert_fn_ok_gt!(function, left_input, right_expr)`\n",
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_ok_gt_as_result_x_arity_2_gt_success() {
        let a: i32 = 2;
        let b = String::from("1");
        let x = assert_fn_ok_gt_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_ok_gt_as_result_x_arity_2_eq_failure() {
        let a: i32 = 1;
        let b = String::from("1");
        let x = assert_fn_ok_gt_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_ok_gt_as_result_x_arity_2_lt_failure() {
        let a: i32 = 1;
        let b = String::from("2");
        let x = assert_fn_ok_gt_as_result!(example_digit_to_string, a, b);
        assert_eq!(
...
mod test_x_panic {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_ok_gt!(function, left_input, right_expr)`\n    function name: `example_digit_to_string`,\n  left input name: `a`,\n  right expr name: `b`,\n       left input: `1`,\n       right expr: `\"1\"`,\n      left output: `\"1\"`,\n             left: `\"1\"`,\n            right: `\"1\"`")]
