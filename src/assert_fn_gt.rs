...
/// //-> panic!("…")
/// // assertion failed: `assert_fn_gt!(fn, left, right)`
/// //    left input: `1`,
/// //   right input: `-2`,
/// //   left output: `1`,
/// //  right output: `2`
...
/// # let expect = "assertion failed: `assert_fn_gt!(fn, left, right)`\n   left input: `1`,\n  right input: `-2`,\n  left output: `1`,\n right output: `2`";
...
macro_rules! assert_fn_gt {
    ($function:path, $left:expr, $right:expr $(,)?) => ({
        ...
        if (left > right) {
            ...
            panic!("assertion failed: `assert_fn_gt!(fn, left, right)`\n   left input: `{:?}`,\n  right input: `{:?}`,\n  left output: `{:?}`,\n right output: `{:?}`", $left, $right, left, right);
        }
    });
...
mod tests {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_gt!(fn, left, right)`\n   left input: `1`,\n  right input: `-1`,\n  left output: `1`,\n right output: `1`")]
