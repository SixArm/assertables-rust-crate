...
/// //-> panic!
/// // assertion failed: `assert_f_ok_ne!(fn, left, right)`
/// //    left input: `\"1\"`,
/// //   right input: `\"1\"`,
/// //   left output: `1`,
/// //  right output: `1`
...
/// # let expect = "assertion failed: `assert_f_ok_ne!(fn, left, right)`\n   left input: `\"1\"`,\n  right input: `\"1\"`,\n  left output: `1`,\n right output: `1`";
...
mod tests {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_ok_ne!(fn, left, right)`\n   left input: `\"1\"`,\n  right input: `\"1\"`,\n  left output: `1`,\n right output: `1`")]
