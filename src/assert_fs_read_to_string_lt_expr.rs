...
//! # Module macros
//!
//! * [`assert_fs_read_to_string_lt_expr`](macro.assert_fs_read_to_string_lt_expr.html)
//! * [`assert_fs_read_to_string_lt_expr_as_result`](macro.assert_fs_read_to_string_lt_expr_as_result.html)
//! * [`debug_assert_fs_read_to_string_lt_expr`](macro.debug_assert_fs_read_to_string_lt_expr.html)
...
///
/// This macro provides the same statements as [`assert_fs_read_to_string_lt_expr`](macro.assert_fs_read_to_string_lt_expr.html),
...
mod tests {
    ...
    #[test]
    fn test_read_to_string_lt_expr_as_result_x_success() {
        let path = DIR.join("alfa.txt");
        let value = String::from("bravo\n");
        let x = assert_fs_read_to_string_lt_expr_as_result!(&path, &value);
        assert_eq!(x, Ok(()));
    }

    #[test]
    fn test_read_to_string_lt_expr_as_result_x_failure() {
...
macro_rules! assert_fs_read_to_string_lt_expr {
    ($a_path:expr,  $b_expr:expr $(,)?) => ({
        match assert_fs_read_to_string_lt_expr_as_result!($a_path, $b_expr) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
///
#[macro_export]
macro_rules! debug_read_to_string_lt_expr {
    ($($arg:tt)*) => {
