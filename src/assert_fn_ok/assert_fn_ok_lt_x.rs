                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.4.0/assertables/macro.assert_fn_ok_lt_x.html\n",
                                        " a_function label: `{}`,\n",
                                        "    a_param label: `{}`,\n",
                                        "    a_param debug: `{:?}`,\n",
                                        "     b_expr label: `{}`,\n",
                        ...
                        Err(
                            format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/9.4.0/assertables/macro.assert_fn_ok_le_x.html\n",
                                    " a_function label: `{}`,\n",
                                    "    a_param label: `{}`,\n",
                                    "    a_param debug: `{:?}`,\n",
                                    "     b_expr label: `{}`,\n",
...
mod tests {
    ...
    mod assert_fn_ok_lt_x_as_result {
        ...
        mod arity_1 {
            ...
            fn lt() {
                let a: i8 = 1;
                let b: i8 = 2;
                let result = assert_fn_ok_lt_x_as_result!(f, a, b);
        ...
        mod arity_0 {
            ...
            fn lt() {
                let b: i8 = 2;
                let result = assert_fn_ok_lt_x_as_result!(f, b);
                assert_eq!(result.unwrap(), 1);
            }
