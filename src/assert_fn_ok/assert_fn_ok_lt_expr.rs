                ...
                if !a_is_ok {
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/8.10.1/assertables/macro.assert_fn_ok_le_expr.html\n",
                            " a_function label: `{}`,\n",
                            "    a_param label: `{}`,\n",
                            "    a_param debug: `{:?}`,\n",
                            "     b_expr label: `{}`,\n",
                    ...
                    if a_ok < $b_expr {
                        ...
                        Err(format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/8.10.1/assertables/macro.assert_fn_ok_lt_expr.html\n",
                                " a_function label: `{}`,\n",
                                "    a_param label: `{}`,\n",
                                "    a_param debug: `{:?}`,\n",
                                "     b_expr label: `{}`,\n",
