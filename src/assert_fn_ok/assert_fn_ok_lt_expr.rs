...
macro_rules! assert_fn_ok_lt_expr_as_result {
    ...
    ($a_function:path, $b_expr:expr $(,)?) => ({
        ...
        if !a_is_ok {
            Err(format!(
                concat!(
                    "assertion failed: `assert_fn_ok_le_expr!(left_function, right_expr)`\n",
                    " left_function label: `{}`,\n",
                    "    right_expr label: `{}`,\n",
                    "    right_expr debug: `{:?}`,\n",
                    "         left result: `{:?}`",
            ...
            if a_ok < $b_expr {
                ...
                Err(format!(
                    concat!(
                        "assertion failed: `assert_fn_ok_lt_expr!(left_function, right_expr)`\n",
                        " left_function label: `{}`,\n",
                        "    right_expr label: `{}`,\n",
                        "    right_expr debug: `{:?}`,\n",
                        "                left: `{:?}`,\n",
    ...
    mod assert_fn_ok_lt_expr_as_result {
        ...
        mod arity_1 {
            ...
            fn test_lt() {
                let a: i8 = 1;
                let b: i8 = 2;
                let x = assert_fn_ok_lt_expr_as_result!(f, a, b);
                assert_eq!(x, Ok(()));
            }
        ...
        mod arity_0 {
            ...
            fn test_lt() {
                let b: i8 = 2;
                let x = assert_fn_ok_lt_expr_as_result!(f, b);
                assert_eq!(x, Ok(()));
            }
