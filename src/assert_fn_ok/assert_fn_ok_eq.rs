    ...
    mod assert_fn_ok_eq_as_result {
        ...
        mod arity_1 {
            ...
            fn test_eq() {
                let a: i8 = 1;
                let b: i8 = 1;
                let result = assert_fn_ok_eq_as_result!(f, a, g, b);
                assert_eq!(result, Ok(()));
            }
        ...
        mod arity_0 {
            ...
            #[test]
            fn test_eq() {
                let result = assert_fn_ok_eq_as_result!(f, f);
                assert_eq!(result, Ok(()));
            }

            #[test]
            fn test_ne() {
                let result = assert_fn_ok_eq_as_result!(f, g);
                assert!(result.is_err());
                assert_eq!(
                    result.unwrap_err(),
                    concat!(
...
/// # });
/// // assertion failed: `assert_fn_ok_eq!(a_function, a_param, b_function, b_param)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_fn_ok_eq.html
/// //  a_function label: `f`,
/// //     a_param label: `a`,
/// //     a_param debug: `1`,
/// //  b_function label: `f`,
