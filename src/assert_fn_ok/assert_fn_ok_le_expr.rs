...
//! # Module macros
//!
//! * [`assert_fn_ok_le_expr`](macro@crate::assert_fn_ok_le_expr)
    ...
    mod assert_fn_ok_le_expr_as_result {
        ...
        mod arity_1 {
            ...
            fn test_lt() {
                let a: i8 = 1;
                let b: i8 = 2;
                let result = assert_fn_ok_le_expr_as_result!(f, a, b);
                assert_eq!(result, Ok(()));
            }
        ...
        mod arity_0 {
            ...
            fn test_lt() {
                let b: i8 = 2;
                let result = assert_fn_ok_le_expr_as_result!(f, b);
                assert_eq!(result, Ok(()));
            }
...
/// # });
/// // assertion failed: `assert_fn_ok_le_expr!(a_function, a_param, b_expr)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_fn_ok_le_expr.html
/// //  a_function label: `f`,
/// //     a_param label: `a`,
/// //     a_param debug: `2`,
/// //      b_expr label: `b`,
