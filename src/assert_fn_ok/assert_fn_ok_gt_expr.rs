...
//! # Module macros
//!
//! * [`assert_fn_ok_gt_expr`](macro@crate::assert_fn_ok_gt_expr)
//! * [`assert_fn_ok_gt_expr_as_result`](macro@crate::assert_fn_ok_gt_expr_as_result)
//! * [`debug_assert_fn_ok_gt_expr`](macro@crate::debug_assert_fn_ok_gt_expr)
                ...
                if !a_is_ok {
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_fn_ok_gt_expr.html\n",
                            " a_function label: `{}`,\n",
                            "    a_param label: `{}`,\n",
                            "    a_param debug: `{:?}`,\n",
                            "     b_expr label: `{}`,\n",
...
mod tests {
    ...
    mod assert_fn_ok_gt_expr_as_result {
...
/// # });
/// // assertion failed: `assert_fn_ok_gt_expr!(a_function, a_param, b_expr)`
/// // https://docs.rs/assertables/8.18.0/assertables/macro.assert_fn_ok_gt_expr.html
/// //  a_function label: `f`,
/// //     a_param label: `a`,
/// //     a_param debug: `1`,
/// //      b_expr label: `b`,
