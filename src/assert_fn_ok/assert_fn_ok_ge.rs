                ...
                if !a_is_ok || !b_is_ok {
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/8.10.1/assertables/macro.assert_fn_err_ge.html\n",
                            " a_function label: `{}`,\n",
                            "    a_param label: `{}`,\n",
                            "    a_param debug: `{:?}`,\n",
                            " b_function label: `{}`,\n",
                    ...
                    if a_ok >= b_ok {
                        ...
                        Err(format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/8.10.1/assertables/macro.assert_fn_ok_ge.html\n",
                                " a_function label: `{}`,\n",
                                "    a_param label: `{}`,\n",
                                "    a_param debug: `{:?}`,\n",
                                " b_function label: `{}`,\n",
    ...
    mod assert_fn_ok_ge_as_result {
        ...
        mod arity_1 {
            ...
            fn test_gt() {
                let a: i8 = 2;
                let b: i8 = 1;
                let result = assert_fn_ok_ge_as_result!(f, a, g, b);
                assert_eq!(result, Ok(()));
            }
        ...
        mod arity_0 {
            ...
            #[test]
            fn test_gt() {
                let result = assert_fn_ok_ge_as_result!(g, f);
                assert_eq!(result, Ok(()));
            }

            #[test]
            fn test_eq() {
                let result = assert_fn_ok_ge_as_result!(f, f);
                assert_eq!(result, Ok(()));
            }

            #[test]
            fn test_lt() {
                let result = assert_fn_ok_ge_as_result!(f, g);
                assert!(result.is_err());
                assert_eq!(
                    result.unwrap_err(),
                    concat!(
