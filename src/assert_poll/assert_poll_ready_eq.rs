                        ...
                        if a_inner == b_inner {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_poll_ready_eq.html\n",
                                    " a label: `{}`,\n",
                                    " a debug: `{:?}`,\n",
                                    " a inner: `{:?}`,\n",
                                    " b label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_poll_ready_eq!(a, b)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_poll_ready_eq.html
/// //  a label: `a`,
/// //  a debug: `Ready(1)`,
/// //  a inner: `1`,
/// //  b label: `b`,
...
macro_rules! assert_poll_ready_eq {
    ($a:expr, $b:expr $(,)?) => {{
        match $crate::assert_poll_ready_eq_as_result!($a, $b) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    }};
