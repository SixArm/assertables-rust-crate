...
#[macro_export]
macro_rules! assume_fn_err_string_lt {
...
mod tests {
    ...
    #[test]
    fn test_assume_fn_err_string_lt_x_arity_2_lt_success() {
        let a = 1;
        let b = 2;
    ...
    #[test]
    fn test_assume_fn_err_string_lt_x_arity_2_eq_failure() {
        let a = 1;
        let b = 1;
        let x = assume_fn_err_string_lt!(f, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assume_fn_err_string_lt_x_arity_2_gt_failure() {
        let a = 2;
        let b = 1;
        let x = assume_fn_err_string_lt!(f, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assume_fn_err_string_lt_x_arity_3_lt_success() {
        let a = 1;
        let b = 2;
        let x = assume_fn_err_string_lt!(f, a, b, "message");
        assert_eq!(
            x.unwrap(),
            true
        );
    ...
    #[test]
    fn test_assume_fn_err_string_lt_x_arity_3_eq_failure() {
        let a = 1;
        let b = 1;
        let x = assume_fn_err_string_lt!(f, a, b, "message");
        assert_eq!(
    ...
    #[test]
    fn test_assume_fn_err_string_lt_x_arity_3_gt_failure() {
        let a = 2;
        let b = 1;
        let x = assume_fn_err_string_lt!(f, a, b, "message");
        assert_eq!(
