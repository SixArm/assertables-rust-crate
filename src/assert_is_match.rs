...
/// # Module macros
///
/// * [`assert_is_match`](macro.assert_is_match.html)
/// * [`assert_is_match_as_result`](macro.assert_is_match_as_result.html)
/// * [`debug_assert_is_match`](macro.debug_assert_is_match.html)
///
#[macro_export]
