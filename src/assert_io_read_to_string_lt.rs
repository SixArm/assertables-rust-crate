...
/// # Module macros
///
/// * [`assert_io_read_to_string_lt`](macro.assert_io_read_to_string_lt.html)
/// * [`assert_io_read_to_string_lt_as_result`](macro.assert_io_read_to_string_lt_as_result.html)
/// * [`debug_assert_io_read_to_string_lt`](macro.debug_assert_io_read_to_string_lt.html)
///
#[macro_export]
...
macro_rules! assert_io_read_to_string_lt {
    ($a_reader:expr, $b_reader:expr $(,)?) => ({
        match assert_io_read_to_string_lt_as_result!($a_reader, $b_reader) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
