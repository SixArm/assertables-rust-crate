...
mod test_x_result {
    ...
    #[test]
    fn test_assert_read_to_string_ge_other_as_result_x_success() {
    ...
    #[test]
    fn test_assert_read_to_string_ge_other_as_result_x_failure() {
...
/// Assert a std::io::Read read_to_string() value is greater than or equal to another.
///
/// This macro provides the same statements as [`assert_read_to_string_ge_other`],
...
///
#[macro_export]
macro_rules! debug_assert_read_to_string_ge_other {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_read_to_string_ge_other!($($arg)*);
        }
    };
}
