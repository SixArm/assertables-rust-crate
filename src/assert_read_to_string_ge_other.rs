...
/// let x = assert_read_to_string_ge_other_as_result!(a, b);
/// //-> Ok(())
/// let actual = x.unwrap();
/// let expect = ();
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_read_to_string_ge_other_as_result_x_arity_2_success() {
        let mut a = "bravo".as_bytes();
        let mut b = "alpha".as_bytes();
        let x = assert_read_to_string_ge_other_as_result!(a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_read_to_string_ge_other_as_result_x_arity_2_failure() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let x = assert_read_to_string_ge_other_as_result!(a, b);
        assert_eq!(
...
macro_rules! assert_read_to_string_ge_other {
    ($a_reader:expr, $b_reader:expr $(,)?) => ({
        match assert_read_to_string_ge_other_as_result!($a_reader, $b_reader) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
mod test_x_panic {
    ...
    #[test]
    fn test_assert_read_to_string_ge_other_x_arity_2_success() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let x = assert_read_to_string_ge_other!(b, a);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_read_to_string_ge_other!(left_reader, right_reader)`\n  left reader name: `a`,\n right reader name: `b`,\n  left reader size: `5`,\n right reader size: `5`,\n  left reader data: `\"alpha\"`,\n right reader data: `\"bravo\"`")]
    fn test_assert_read_to_string_ge_other_x_arity_2_failure() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let _x = assert_read_to_string_ge_other!(a, b);
    }

    #[test]
    fn test_assert_read_to_string_ge_other_x_arity_3_success() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let x = assert_read_to_string_ge_other!(b, a, "message");
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_read_to_string_ge_other_x_arity_3_failure() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let _x = assert_read_to_string_ge_other!(a, b, "message");
    }
