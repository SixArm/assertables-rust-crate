...
//! # Module macros
//!
//! * [`assert_fn_err_ge`](macro.assert_fn_err_ge.html)
//! * [`assert_fn_err_ge_as_result`](macro.assert_fn_err_ge_as_result.html)
//! * [`debug_assert_fn_err_ge`](macro.debug_assert_fn_err_ge.html)
