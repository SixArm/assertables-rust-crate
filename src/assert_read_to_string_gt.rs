...
/// //-> panic!
/// // assertion failed: `assert_read_to_string_gt!(left, right)`
/// //   left: `\"a\"`,
/// //  right: `\"b\"`
/// # });
/// # let actual: String = result.unwrap_err().downcast::<String>().unwrap().to_string();
/// # let expect = "assertion failed: `assert_read_to_string_gt!(left, right)`\n  left: `\"a\"`,\n right: `\"b\"`";
...
mod tests {
    ...
    fn test_assert_read_to_string_gt_x_arity_2_success() {
        let mut a = "a".as_bytes();
        let mut b = "b".as_bytes();
        let x = assert_read_to_string_gt!(b, a);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_read_to_string_gt!(left, right)`\n  left: `\"a\"`,\n right: `\"b\"`")]
    fn test_assert_read_to_string_gt_x_arity_2_failure() {
        let mut a = "a".as_bytes();
        let mut b = "b".as_bytes();
        let _x = assert_read_to_string_gt!(a, b);
    }

    #[test]
    fn test_assert_assert_read_to_string_gt_x_arity_3_success() {
        let mut a = "a".as_bytes();
        let mut b = "b".as_bytes();
        let x = assert_read_to_string_gt!(b, a, "message");
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_assert_read_to_string_gt_x_arity_3_failure() {
        let mut a = "a".as_bytes();
        let mut b = "b".as_bytes();
        let _x = assert_read_to_string_gt!(a, b, "message");
    }
