                ...
                if a_len <= $b {
                    ...
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_len_le_expr.html\n",
                            " a label: `{}`,\n",
                            " a debug: `{:?}`,\n",
                            " a.len(): `{:?}`,\n",
                            " b label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_len_le_expr!(a, b)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_len_le_expr.html
/// //  a label: `a`,
/// //  a debug: `\"xx\"`,
/// //  a.len(): `2`",
/// //  b label: `b`,
