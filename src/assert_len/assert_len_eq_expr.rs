                ...
                if a_len == $b {
                    ...
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_len_eq_expr.html\n",
                            " a label: `{}`,\n",
                            " a debug: `{:?}`,\n",
                            " a.len(): `{:?}`,\n",
                            " b label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_len_eq_expr!(a, b)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_len_eq_expr.html
/// //  a label: `a`,
/// //  a debug: `\"x\"`,
/// //  a.len(): `1`",
/// //  b label: `b`,
