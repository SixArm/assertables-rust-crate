...
/// //-> panic!("…")
/// // assertion failed: `assert_fn_err_string_le!(fn, left, right)`
/// //    left input: `20`,
/// //   right input: `10`,
...
/// # let expect = "assertion failed: `assert_fn_err_string_le!(fn, left, right)`\n   left input: `20`,\n  right input: `10`,\n  left output: `\"20 is out of range\"`,\n right output: `\"10 is out of range\"`";
...
mod tests {
    ...
    fn test_assert_fn_err_string_le_x_arity_2_gt_failure() {
        let a = 20;
        let b = 10;
        let _x = assert_fn_err_string_le!(digit_string, a, b);
    }
    ...
    fn test_assert_fn_err_string_le_x_arity_3_failure() {
        let a = 20;
        let b = 10;
        let _x = assert_fn_err_string_le!(digit_string, a, b, "message");
    }
