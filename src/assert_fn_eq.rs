...
/// # Module macros
///
/// * [`assert_fn_eq`](macro.assert_fn_eq.html)
/// * [`assert_fn_eq_as_result`](macro.assert_fn_eq_as_result.html)
/// * [`debug_assert_fn_eq`](macro.debug_assert_fn_eq.html)
///
#[macro_export]
    ...
    mod assert_fn_eq_as_result {
        ...
        pub(crate) mod arity_1 {
            ...
            fn test_eq() {
                let a: i8 = 1;
                let b: i8 = 1;
                let x = assert_fn_eq_as_result!(f, a, g, b);
                assert_eq!(x, Ok(()));
            }
        ...
        mod arity_0 {
            ...
            #[test]
            fn test_ne() {
                let x = assert_fn_eq_as_result!(f, g);
                assert!(x.is_err());
                assert_eq!(
                    x.unwrap_err(),
                    concat!(
