...
/// # Module macros
///
/// * [`assert_program_args_stdout_lt`](macro.assert_program_args_stdout_lt.html)
/// * [`assert_program_args_stdout_lt_as_result`](macro.assert_program_args_stdout_lt_as_result.html)
/// * [`debug_assert_program_args_stdout_lt`](macro.debug_assert_program_args_stdout_lt.html)
///
#[macro_export]
...
mod tests {
    ...
    fn test_assert_program_args_stdout_lt_as_result_x_success() {
        ...
        let x = assert_program_args_stdout_lt_as_result!(&a_program, &a_args, &b_program, &b_args);
        assert_eq!(x.unwrap(), ());
    }
...
macro_rules! assert_program_args_stdout_lt {
    ($a_program:expr, $a_args:expr, $b_program:expr, $b_args:expr $(,)?) => ({
        match assert_program_args_stdout_lt_as_result!($a_program, $a_args, $b_program, $b_args) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
/// Assert a command (built with program and args) stdout string is less than another.
///
/// This macro provides the same statements as [`assert_program_args_stdout_lt`],
