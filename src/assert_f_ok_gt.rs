...
/// //-> panic!("…")
/// // assertion failed: `assert_f_ok_gt!(fn, left, right)`
/// //    left input: `\"1\"`,
/// //   right input: `\"2\"`,
/// //   left output: `1`,
/// //  right output: `2`
...
/// # let expect = "assertion failed: `assert_f_ok_gt!(fn, left, right)`\n   left input: `\"1\"`,\n  right input: `\"2\"`,\n  left output: `1`,\n right output: `2`";
...
#[macro_export]
macro_rules! assert_f_ok_gt {
    ($function:path, $left:expr, $right:expr $(,)?) => ({
        let left = $function($left);
        let right = $function($right);
        if !left.is_ok() || !right.is_ok() {
            panic!("assertion failed: `assert_f_ok_gt!(fn, left, right)`\n   left input: `{:?}`,\n  right input: `{:?}`\n  left output is_ok(): `{:?}`,\n right output is_ok(): `{:?}`", $left, $right, left.is_ok(), right.is_ok());
        } else {
...
mod tests {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_ok_gt!(fn, left, right)`\n   left input: `\"1\"`,\n  right input: `\"1\"`,\n  left output: `1`,\n right output: `1`")]
