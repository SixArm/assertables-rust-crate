...
///
/// # fn main() {
/// assert_fn_err_string_eq!(example_digit_to_string, 10, 10);
/// //-> ()
///
/// # let result = panic::catch_unwind(|| {
/// assert_fn_err_string_eq!(example_digit_to_string, 10, 20);
/// //-> panic!("…")
/// // assertion failed: `assert_fn_err_string_eq!(function, left, right)`
...
/// # let expect = "assertion failed: `assert_fn_err_string_eq!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `20`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"20 is out of range\"`";
...
mod tests {
    ...
    fn test_assert_fn_err_string_eq_x_arity_2_eq_success() {
        let a = 10;
        let b = 10;
        let x = assert_fn_err_string_eq!(example_digit_to_string, a, b);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_err_string_eq!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `20`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"20 is out of range\"`")]
    fn test_assert_fn_err_string_eq_x_arity_2_ne_failure() {
        let a = 10;
        let b = 20;
        let _x = assert_fn_err_string_eq!(example_digit_to_string, a, b);
    }
    ...
    fn test_assert_fn_err_string_eq_x_arity_3_eq_success() {
        let a = 10;
        let b = 10;
        let x = assert_fn_err_string_eq!(example_digit_to_string, a, b, "message");
        assert_eq!(x, ());
    }
    ...
    fn test_assert_fn_err_string_eq_x_arity_3_ne_failure() {
        let a = 10;
        let b = 20;
        let _x = assert_fn_err_string_eq!(example_digit_to_string, a, b, "message");
    }
