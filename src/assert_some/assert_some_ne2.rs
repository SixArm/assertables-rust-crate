...
//! # Module macros
//!
//! * [`assert_some_ne2`](macro@crate::assert_some_ne2)
//! * [`assert_some_ne2_as_result`](macro@crate::assert_some_ne2_as_result)
//! * [`debug_assert_some_ne2`](macro@crate::debug_assert_some_ne2)
...
///
/// This macro provides the same statements as [`assert_some_ne2`](macro.assert_some_ne2.html),
...
///
#[macro_export]
macro_rules! assert_some_ne2_as_result {
    ($a:expr, $b:expr $(,)?) => {{
        match (&$a, &$b) {
            (a, b) => {
                match (a, b) {
                    (Some(a1), Some(b1)) => {
                        if a1 != b1 {
                            ...
                            Err(
                                format!(
                                    concat!(
                                        "assertion failed: `assert_some_ne2!(a, b)`\n",
                                        "https://docs.rs/assertables/9.0.0/assertables/macro.assert_some_ne2.html\n",
                                        " a label: `{}`,\n",
                                        " a debug: `{:?}`,\n",
                                        " a inner: `{:?}`,\n",
                                        " b label: `{}`,\n",
...
///
#[macro_export]
macro_rules! assert_some_ne2 {
    ($a:expr, $b:expr $(,)?) => {{
        match $crate::assert_some_ne2_as_result!($a, $b) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
...
///
#[macro_export]
macro_rules! debug_assert_some_ne2 {
    ($($arg:tt)*) => {
