                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.4.0/assertables/macro.assert_some_eq_x.html\n",
                                " a label: `{}`,\n",
                                " a debug: `{:?}`,\n",
                                " a inner: `{:?}`,\n",
                                " b label: `{}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_some_eq_x_expr_as_result_x_success() {
        let a: Option<i8> = Option::Some(1);
        let b: i8 = 1;
    ...
    #[test]
    fn test_assert_some_eq_x_expr_as_result_x_failure_because_not_some() {
