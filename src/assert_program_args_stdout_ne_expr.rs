...
//! # Module macros
//!
//! * [`assert_program_args_stdout_ne_expr`](macro.assert_program_args_stdout_ne_expr.html)
//! * [`assert_program_args_stdout_ne_expr_as_result`](macro.assert_program_args_stdout_ne_expr_as_result.html)
//! * [`debug_assert_program_args_stdout_ne_expr`](macro.debug_assert_program_args_stdout_ne_expr.html)
...
mod tests {
    ...
    #[test]
    fn test_assert_program_args_stdout_ne_expr_as_result_x_success() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "hello"];
        let b = String::from("zzz");
        let x = assert_program_args_stdout_ne_expr_as_result!(&a_program, &a_args, b);
        assert_eq!(x.unwrap(), ());
    }

    #[test]
    fn test_assert_program_args_stdout_ne_expr_as_result_x_failure() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "hello"];
...
macro_rules! assert_program_args_stdout_ne_expr {
    ($a_program:expr, $a_args:expr, $b_expr:expr $(,)?) => ({
        match assert_program_args_stdout_ne_expr_as_result!($a_program, $a_args, $b_expr) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
