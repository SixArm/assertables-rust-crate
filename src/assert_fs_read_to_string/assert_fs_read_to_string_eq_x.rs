                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.5.4/assertables/macro.assert_fs_read_to_string_eq_x.html\n",
                                        " a_path label: `{}`,\n",
                                        " a_path debug: `{:?}`,\n",
                                        " b_expr label: `{}`,\n",
                                        " b_expr debug: `{:?}`,\n",
...
mod test_assert_fs_read_to_string_eq_x_as_result {
    ...
    fn eq() {
        ...
        let value = String::from("alfa\n");
        let actual = assert_fs_read_to_string_eq_x_as_result!(&path, &value);
...
mod test_assert_fs_read_to_string_eq_x {
    ...
    fn eq() {
        let path = DIR.join("alfa.txt");
        let value = String::from("alfa\n");
        let actual = assert_fs_read_to_string_eq_x!(&path, &value);
    ...
    fn lt() {
        ...
        let value = String::from("bravo\n");
        let result = panic::catch_unwind(|| {
            let _actual = assert_fs_read_to_string_eq_x!(&path, &value);
        });
        let message = format!(
            concat!(
                "assertion failed: `assert_fs_read_to_string_eq_x!(a_path, b_expr)`\n",
