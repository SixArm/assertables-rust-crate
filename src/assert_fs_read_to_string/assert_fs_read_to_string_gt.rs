...
mod tests {
    ...
    #[test]
    fn test_read_to_string_gt_as_result_x_success_because_gt() {
    ...
    #[test]
    fn test_read_to_string_gt_as_result_x_failure_because_eq() {
    ...
    #[test]
    fn test_read_to_string_gt_as_result_x_failure_because_lt() {
        let a = DIR.join("alfa.txt");
