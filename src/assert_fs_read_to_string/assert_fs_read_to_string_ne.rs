...
//! assert_fs_read_to_string_ne!(&path, &value);
//! # }
//! ```
//!
//! # Module macros
                    ...
                    Ok(a_string) => {
                        ...
                        if a_string != b_string {
                            ...
                            Err(
                                format!(
                                    concat!(
                                        "assertion failed: `assert_fs_read_to_string_ne!(a_path, b_expr)`\n",
...
macro_rules! assert_fs_read_to_string_ne {
    ($a_path:expr, $b_expr:expr $(,)?) => {{
        match $crate::assert_fs_read_to_string_ne_as_result!($a_path, $b_expr) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
