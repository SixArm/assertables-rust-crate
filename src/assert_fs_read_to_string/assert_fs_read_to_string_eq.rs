...
//! assert_fs_read_to_string_eq!(&path, &value);
//! # }
//! ```
//!
//! # Module macros
                    ...
                    Ok(a_string) => {
                        ...
                        if a_string == b_string {
                            ...
                            Err(
                                format!(
                                    concat!(
                                        "assertion failed: `assert_fs_read_to_string_eq!(a_path, b_expr)`\n",
...
mod tests {
    ...
    fn test_read_to_string_eq_expr_as_result_x_success_because_eq() {
        ...
        let value = String::from("alfa\n");
        let result = assert_fs_read_to_string_eq_as_result!(&path, &value);
    }
...
macro_rules! assert_fs_read_to_string_eq {
    ($a_path:expr, $b_expr:expr $(,)?) => {{
        match $crate::assert_fs_read_to_string_eq_as_result!($a_path, $b_expr) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
