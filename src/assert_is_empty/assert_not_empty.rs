...
mod tests {
    ...
    #[test]
    fn test_assert_not_empty_as_result_x_success() {
        let a = "alfa";
    ...
    #[test]
    fn test_assert_not_empty_as_result_x_failure() {
        let a = "";
        let result = assert_not_empty_as_result!(a);
...
/// # });
/// // assertion failed: `assert_not_empty!(a)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_not_empty.html
/// //  label: `a`,
/// //  debug: `\"\"`
