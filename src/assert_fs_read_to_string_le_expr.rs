...
//! # Module macros
//!
//! * [`assert_fs_read_to_string_le_expr`](macro.assert_fs_read_to_string_le_expr.html)
//! * [`assert_fs_read_to_string_le_expr_as_result`](macro.assert_fs_read_to_string_le_expr_as_result.html)
//! * [`debug_assert_fs_read_to_string_le_expr`](macro.debug_assert_fs_read_to_string_le_expr.html)
...
///
#[macro_export]
macro_rules! debug_read_to_string_le_expr {
    ($($arg:tt)*) => {
