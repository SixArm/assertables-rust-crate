...
/// * [`debug_assert_command_stderr_is_match`](macro@crate::debug_assert_command_stderr_is_match)
///
#[deprecated(note = "Please rename from `assert_command_stderr_is_match_as_result` to `assert_command_stderr_string_is_match_as_result` because this macro does the comparison via a Rust UTF-8 String.")]
#[macro_export]
...
/// # });
/// // assertion failed: `assert_command_stderr_is_match!(command, matcher)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_command_stderr_is_match.html
...
/// * [`debug_assert_command_stderr_is_match`](macro@crate::debug_assert_command_stderr_is_match)
///
#[deprecated(note = "Please rename from `assert_command_stderr_is_match` to `assert_command_stderr_string_is_match` because this macro does the comparison via a Rust UTF-8 String.")]
#[macro_export]
macro_rules! assert_command_stderr_is_match {
    ($command:expr, $matcher:expr $(,)?) => {{
        match $crate::assert_command_stderr_is_match_as_result!($command, $matcher) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    }};
...
/// * [`debug_assert_command_stderr_is_match`](macro@crate::debug_assert_command_stderr_is_match)
///
#[deprecated(note = "Please rename from `debug_assert_command_stderr_is_match` to `debug_assert_command_stderr_string_is_match` because this macro does the comparison via a Rust UTF-8 String.")]
#[macro_export]
