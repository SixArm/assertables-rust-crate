...
///
#[deprecated(
    note = "Please rename from `assert_command_stdout_is_match_as_result` into `assert_command_stdout_string_is_match_as_result`."
)]
#[macro_export]
...
///
#[deprecated(
    note = "Please rename from `assert_command_stdout_is_match` into `assert_command_stdout_string_is_match`."
)]
#[macro_export]
...
///
#[deprecated(
    note = "Please rename from `debug_assert_command_stdout_is_match` into `debug_assert_command_stdout_string_is_match`."
)]
#[macro_export]
macro_rules! debug_assert_command_stdout_is_match {
    ($($arg:tt)*) => {
        $crate::debug_assert_command_stdout_string_is_match!($($arg)*)
    }
}
