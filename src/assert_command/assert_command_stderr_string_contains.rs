...
mod tests {
    ...
    #[test]
    fn test_assert_command_stderr_string_contains_x_success() {
    ...
    #[test]
    fn test_assert_command_stderr_string_contains_x_failure() {
        let mut a = Command::new("bin/printf-stderr");
        a.args(["%s", "alfa"]);
        let b = "zz";
        let result = assert_command_stderr_string_contains_as_result!(a, b);
...
/// # });
/// // assertion failed: `assert_command_stderr_string_contains!(command, containee)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_command_stderr_string_contains.html
