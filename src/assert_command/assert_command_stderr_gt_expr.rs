                        ...
                        if a.gt($b_expr) {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_command_stderr_gt_expr.html\n",
                                    " command label: `{}`,\n",
                                    " command debug: `{:?}`,\n",
                                    "    expr label: `{}`,\n",
                                    "    expr debug: `{:?}`,\n",
...
/// # });
/// // assertion failed: `assert_command_stderr_gt_expr!(command, expr)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_command_stderr_gt_expr.html
