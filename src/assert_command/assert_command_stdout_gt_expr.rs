...
//! # Module macros
//!
//! * [`assert_command_stdout_gt_expr`](macro@crate::assert_command_stdout_gt_expr)
//! * [`assert_command_stdout_gt_expr_as_result`](macro@crate::assert_command_stdout_gt_expr_as_result)
//! * [`debug_assert_command_stdout_gt_expr`](macro@crate::debug_assert_command_stdout_gt_expr)
...
mod tests {
    ...
    #[test]
    fn test_assert_command_stdout_gt_expr_as_result_x_success_because_gt() {
    ...
    #[test]
    fn test_assert_command_stdout_gt_expr_as_result_x_failure_because_eq() {
        let mut a = Command::new("bin/printf-stdout");
        a.args(["%s", "alfa"]);
    ...
    #[test]
    fn test_assert_command_stdout_gt_expr_as_result_x_failure_because_lt() {
        let mut a = Command::new("bin/printf-stdout");
        a.args(["%s", "alfa"]);
        let b = vec![b'z', b'z'];
        let result = assert_command_stdout_gt_expr_as_result!(a, &b);
...
/// # });
/// // assertion failed: `assert_command_stdout_gt_expr!(command, expr)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_command_stdout_gt_expr.html
...
/// (command ⇒ stdout) = (expr into string)
///
/// This macro provides the same statements as [`assert_command_stdout_gt_expr`](macro.assert_command_stdout_gt_expr.html),
...
///
#[macro_export]
macro_rules! debug_assert_command_stdout_gt_expr {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_command_stdout_gt_expr!($($arg)*);
        }
    };
}
