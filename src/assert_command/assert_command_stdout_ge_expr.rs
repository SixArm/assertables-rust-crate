                        ...
                        if a.ge($b_expr) {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_command_stdout_ge_expr.html\n",
                                    " command label: `{}`,\n",
                                    " command debug: `{:?}`,\n",
                                    "    expr label: `{}`,\n",
                                    "    expr debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_command_stdout_ge_expr_as_result_x_success_because_gt() {
    ...
    #[test]
    fn test_assert_command_stdout_ge_expr_as_result_x_success_because_eq() {
        let mut a = Command::new("bin/printf-stdout");
        a.args(["%s", "alfa"]);
    ...
    #[test]
    fn test_assert_command_stdout_ge_expr_as_result_x_failure_because_lt() {
        let mut a = Command::new("bin/printf-stdout");
        a.args(["%s", "alfa"]);
        let b = vec![b'z', b'z'];
        let result = assert_command_stdout_ge_expr_as_result!(a, &b);
...
/// # });
/// // assertion failed: `assert_command_stdout_ge_expr!(command, expr)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_command_stdout_ge_expr.html
