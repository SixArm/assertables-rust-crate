...
mod tests {
    ...
    #[test]
    fn test_assert_command_stderr_ge_as_result_x_success_because_gt() {
        let mut a = Command::new("bin/printf-stderr");
        a.args(["%s", "alfa"]);
        let mut b = Command::new("bin/printf-stderr");
        b.args(["%s", "aa"]);
    ...
    #[test]
    fn test_assert_command_stderr_ge_as_result_x_success_because_eq() {
        let mut a = Command::new("bin/printf-stderr");
        a.args(["%s", "alfa"]);
        let mut b = Command::new("bin/printf-stderr");
        b.args(["%s", "alfa"]);
    ...
    #[test]
    fn test_assert_command_stderr_ge_as_result_x_failure_because_lt() {
        let mut a = Command::new("bin/printf-stderr");
        a.args(["%s", "alfa"]);
        let mut b = Command::new("bin/printf-stderr");
        b.args(["%s", "zz"]);
...
/// # });
/// // assertion failed: `assert_command_stderr_ge!(a_command, b_command)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_command_stderr_ge.html
/// //  a label: `a`,
/// //  a debug: `\"bin/printf-stderr\" \"%s\" \"alfa\"`,
/// //  b label: `b`,
/// //  b debug: `\"bin/printf-stderr\" \"%s\" \"zz\"`,
