...
//! assert_command_stderr_ge!(command, bytes);
//! # }
//! ```
//!
//! # Module macros
                    ...
                    Ok(a) => {
                        ...
                        if a.ge(&$b_expr) {
                            ...
                            Err(
                                format!(
                                    concat!(
                                        "assertion failed: `assert_command_stderr_ge!(command, expr)`\n",
...
macro_rules! assert_command_stderr_ge {
    ($a_command:expr, $b_expr:expr $(,)?) => {{
        match $crate::assert_command_stderr_ge_as_result!($a_command, $b_expr) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
