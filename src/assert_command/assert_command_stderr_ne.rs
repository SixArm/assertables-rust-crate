...
//! assert_command_stderr_ne!(command, bytes);
//! # }
//! ```
//!
//! # Module macros
                    ...
                    Ok(a) => {
                        ...
                        if a.ne(&$b_expr) {
                            ...
                            Err(
                                format!(
                                    concat!(
                                        "assertion failed: `assert_command_stderr_ne!(command, expr)`\n",
...
macro_rules! assert_command_stderr_ne {
    ($a_command:expr, $b_expr:expr $(,)?) => {{
        match $crate::assert_command_stderr_ne_as_result!($a_command, $b_expr) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
