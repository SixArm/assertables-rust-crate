                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.1.0/assertables/macro.assert_command_stdout_string_is_match.html\n",
                                        " command label: `{}`,\n",
                                        " command debug: `{:?}`,\n",
                                        " matcher label: `{}`,\n",
                                        " matcher debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_command_stdout_string_is_match_as_result_x_success() {
    ...
    #[test]
    fn test_assert_command_stdout_string_is_match_as_result_x_failure() {
        let mut a = Command::new("bin/printf-stdout");
        a.args(["%s", "alfa"]);
