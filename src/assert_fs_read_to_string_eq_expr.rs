...
//! # Module macros
//!
//! * [`assert_fs_read_to_string_eq_expr`](macro.assert_fs_read_to_string_eq_expr.html)
//! * [`assert_fs_read_to_string_eq_expr_as_result`](macro.assert_fs_read_to_string_eq_expr_as_result.html)
//! * [`debug_assert_fs_read_to_string_eq_expr`](macro.debug_assert_fs_read_to_string_eq_expr.html)
...
mod tests {
    ...
    fn test_read_to_string_eq_expr_as_result_x_success() {
        ...
        let value = String::from("alfa\n");
        let x = assert_fs_read_to_string_eq_expr_as_result!(&path, &value);
        assert_eq!(x, Ok(()));
    }
...
///
#[macro_export]
macro_rules! debug_read_to_string_eq_expr {
    ($($arg:tt)*) => {
