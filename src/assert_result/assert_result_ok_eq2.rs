...
/// Assert two expressions are Ok and their values are equal.
///
/// Deprecated. Please rename from `debug_assert_result_ok_eq2` into `debug_assert_ok_eq2` because more developers prefer the shorter name.
///
#[deprecated(
    note = "Please rename from `debug_assert_result_ok_eq2` into `debug_assert_ok_eq2` because more developers prefer the shorter name."
)]
#[macro_export]
