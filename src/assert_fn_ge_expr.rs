...
/// # Module macros
///
/// * [`assert_fn_ge_expr`](macro.assert_fn_ge_expr.html)
/// * [`assert_fn_ge_expr_as_result`](macro.assert_fn_ge_expr_as_result.html)
/// * [`debug_assert_fn_ge_expr`](macro.debug_assert_fn_ge_expr.html)
///
#[macro_export]
