...
///
#[macro_export]
macro_rules! assert_delta_eq_x_as_result {
                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.5.0/assertables/macro.assert_delta_eq_x.html\n",
                                        " a label: `{}`,\n",
                                        " a debug: `{:?}`,\n",
                                        " b label: `{}`,\n",
                                        " b debug: `{:?}`,\n",
...
#[cfg(test)]
mod test_assert_delta_eq_x_as_result {
...
///
#[macro_export]
macro_rules! assert_delta_eq_x {
    ($a:expr, $b:expr, $x:expr $(,)?) => {{
        match $crate::assert_delta_eq_x_as_result!($a, $b, $x) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
...
///
#[macro_export]
macro_rules! debug_assert_delta_eq_x {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_delta_eq_x!($($arg)*);
        }
    };
}
