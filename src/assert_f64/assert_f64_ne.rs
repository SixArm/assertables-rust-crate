//! Assert a floating point 64-bit number is not equal to another within 2.0 * f64::EPSILON.
//!
//! Pseudocode:<br>
//! a ≠ b
//!
...
mod test_assert_f64_ne_as_result {
    ...
    fn eq() {
        ...
        let message = concat!(
            ...
            " b label: `b`,\n",
            " b debug: `0.3333333333333334`,\n",
            "  Δ: `0.00000000000000011102230246251565`,\n",
