...
mod tests {
    ...
    #[test]
    fn test_assert_program_args_stdout_le_as_result_x_success_because_lt() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "alfa"];
        let b_program = "bin/printf-stdout";
        let b_args = ["%s%s", "z", "z"];
    ...
    #[test]
    fn test_assert_program_args_stdout_le_as_result_x_success_because_eq() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "alfa"];
        let b_program = "bin/printf-stdout";
    ...
    #[test]
    fn test_assert_program_args_stdout_le_as_result_x_failure_because_gt() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "alfa"];
        let b_program = "bin/printf-stdout";
        let b_args = ["%s%s", "a", "a"];
...
/// # });
/// // assertion failed: `assert_program_args_stdout_le!(a_program, a_args, b_program, b_args)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_program_args_stdout_le.html
/// //  a_program label: `&a_program`,
/// //  a_program debug: `\"bin/printf-stdout\"`,
/// //     a_args label: `&a_args`,
/// //     a_args debug: `[\"%s\", \"alfa\"]`,
