...
//! # Module macros
//!
//! * [`assert_program_args_stderr_gt_expr`](macro@crate::assert_program_args_stderr_gt_expr)
//! * [`assert_program_args_stderr_gt_expr_as_result`](macro@crate::assert_program_args_stderr_gt_expr_as_result)
//! * [`debug_assert_program_args_stderr_gt_expr`](macro@crate::debug_assert_program_args_stderr_gt_expr)
...
mod tests {
    ...
    fn test_assert_program_args_stderr_gt_expr_as_result_x_success() {
        ...
        let x = assert_program_args_stderr_gt_expr_as_result!(&a_program, &a_args, b);
        assert_eq!(x.unwrap(), ());
    }
...
macro_rules! assert_program_args_stderr_gt_expr {
    ($a_program:expr, $a_args:expr, $b_expr:expr $(,)?) => ({
        match assert_program_args_stderr_gt_expr_as_result!($a_program, $a_args, $b_expr) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
/// Assert a command (built with program and args) stderr string is greater than an expression.
///
/// This macro provides the same statements as [`assert_program_args_stderr_gt_expr`](macro.assert_program_args_stderr_gt_expr.html),
...
macro_rules! debug_assert_program_args_stderr_gt_expr {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_program_args_stderr_gt_expr!($($arg)*);
        }
    };
}
