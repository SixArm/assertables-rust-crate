...
mod tests {
    ...
    #[test]
    fn test_assert_program_args_stdout_string_is_match_as_result_x_success() {
    ...
    #[test]
    fn test_assert_program_args_stdout_string_is_match_as_result_x_failure() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "alfa"];
...
/// # });
/// // assertion failed: `assert_program_args_stdout_string_is_match!(a_program, b_matcher)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_program_args_stdout_string_is_match.html
