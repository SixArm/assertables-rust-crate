...
//! # Module macros
//!
//! * [`assert_program_args_stderr_eq_expr`](macro@crate::assert_program_args_stderr_eq_expr)
//! * [`assert_program_args_stderr_eq_expr_as_result`](macro@crate::assert_program_args_stderr_eq_expr_as_result)
//! * [`debug_assert_program_args_stderr_eq_expr`](macro@crate::debug_assert_program_args_stderr_eq_expr)
                        ...
                        if a.eq($b_expr) {
                            ...
                            Err(format!(
                                concat!(
                                    ...
                                    "https://docs.rs/assertables/8.16.0/assertables/macro.assert_program_args_stderr_eq_expr.html\n",
                                    " a_program label: `{}`,\n",
                                    " a_program debug: `{:?}`,\n",
                                    "    a_args label: `{}`,\n",
                                    "    a_args debug: `{:?}`,\n",
...
macro_rules! assert_program_args_stderr_eq_expr {
    ($a_program:expr, $a_args:expr, $b_expr:expr $(,)?) => {{
        match $crate::assert_program_args_stderr_eq_expr_as_result!($a_program, $a_args, $b_expr) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    }};
...
macro_rules! debug_assert_program_args_stderr_eq_expr {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_program_args_stderr_eq_expr!($($arg)*);
        }
    };
}
