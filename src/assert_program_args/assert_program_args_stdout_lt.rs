...
mod tests {
    ...
    fn test_assert_program_args_stdout_lt_as_result_x_success() {
        ...
        let b_program = "bin/printf-stdout";
        let b_args = ["%s%s", "z", "z"];
        let result = assert_program_args_stdout_lt_as_result!(&a_program, &a_args, &b_program, &b_args);
...
/// # });
/// // assertion failed: `assert_program_args_stdout_lt!(a_program, a_args, b_program, b_args)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_program_args_stdout_lt.html
/// //  a_program label: `&a_program`,
/// //  a_program debug: `\"bin/printf-stdout\"`,
/// //     a_args label: `&a_args`,
/// //     a_args debug: `[\"%s\", \"alfa\"]`,
