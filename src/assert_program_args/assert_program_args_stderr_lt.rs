                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.5.5/assertables/macro.assert_program_args_stderr_lt.html\n",
                                        " a_program label: `{}`,\n",
                                        " a_program debug: `{:?}`,\n",
                                        "    a_args label: `{}`,\n",
                                        "    a_args debug: `{:?}`,\n",
...
mod test_assert_program_args_stderr_lt_as_result {
    ...
    fn lt() {
        ...
        let b_args = ["%s", "zz"];
        let actual =
            assert_program_args_stderr_lt_as_result!(&a_program, &a_args, &b_program, &b_args);
        assert_eq!(
            actual.unwrap(),
