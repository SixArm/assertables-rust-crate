...
mod tests {
    ...
    fn test_assert_program_args_stderr_gt_as_result_x_success_because_gt() {
        ...
        let b_program = "bin/printf-stderr";
        let b_args = ["%s", "aa"];
        let result = assert_program_args_stderr_gt_as_result!(&a_program, &a_args, &b_program, &b_args);
...
/// # });
/// // assertion failed: `assert_program_args_stderr_gt!(a_program, a_args, b_program, b_args)`
/// // https://docs.rs/assertables/8.16.0/assertables/macro.assert_program_args_stderr_gt.html
/// //  a_program label: `&a_program`,
/// //  a_program debug: `\"bin/printf-stderr\"`,
/// //     a_args label: `&a_args`,
/// //     a_args debug: `[\"%s\", \"alfa\"]`,
