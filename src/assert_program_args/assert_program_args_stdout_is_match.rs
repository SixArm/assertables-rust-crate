...
/// * [`debug_assert_program_args_stdout_is_match`](macro@crate::debug_assert_program_args_stdout_is_match)
///
#[deprecated(note = "Please rename from `assert_program_args_stdout_is_match_as_result` to `assert_program_args_stdout_string_is_match_as_result` because this macro does the comparison via a Rust UTF-8 String.")]
#[macro_export]
                ...
                if a_output.is_err() {
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_program_args_stdout_is_match.html\n",
                            " a_program label: `{}`,\n",
                            " a_program debug: `{:?}`,\n",
                            "    a_args label: `{}`,\n",
                            "    a_args debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_program_args_stdout_is_match_as_result_x_success() {
    ...
    #[test]
    fn test_assert_program_args_stdout_is_match_as_result_x_failure() {
        let a_program = "bin/printf-stdout";
        let a_args = ["%s", "alfa"];
...
/// # });
/// // assertion failed: `assert_program_args_stdout_is_match!(a_program, b_matcher)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_program_args_stdout_is_match.html
...
/// * [`debug_assert_program_args_stdout_is_match`](macro@crate::debug_assert_program_args_stdout_is_match)
///
#[deprecated(note = "Please rename from `assert_program_args_stdout_is_match` to `assert_program_args_stdout_string_is_match` because this macro does the comparison via a Rust UTF-8 String.")]
#[macro_export]
...
/// * [`debug_assert_program_args_stdout_is_match`](macro@crate::debug_assert_program_args_stdout_is_match)
///
#[deprecated(note = "Please rename from `debug_assert_program_args_stdout_is_match` to `debug_assert_program_args_stdout_string_is_match` because this macro does the comparison via a Rust UTF-8 String.")]
#[macro_export]
macro_rules! debug_assert_program_args_stdout_is_match {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_program_args_stdout_is_match!($($arg)*);
        }
    };
}
