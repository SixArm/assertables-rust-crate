                ...
                if a_output.is_err() {
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_program_args_stderr_is_match.html\n",
                            " a_program label: `{}`,\n",
                            " a_program debug: `{:?}`,\n",
                            "    a_args label: `{}`,\n",
                            "    a_args debug: `{:?}`,\n",
...
/// # });
/// // assertion failed: `assert_program_args_stderr_is_match!(a_program, b_matcher)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_program_args_stderr_is_match.html
