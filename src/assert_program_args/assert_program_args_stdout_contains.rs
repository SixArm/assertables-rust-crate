...
///
#[deprecated(
    note = "Please rename from `assert_program_args_stdout_contains_as_result` to `assert_program_args_stdout_string_contains_as_result`."
)]
#[macro_export]
macro_rules! assert_program_args_stdout_contains_as_result {
    ($($arg:tt)*) => {
        $crate::assert_program_args_stdout_string_contains_as_result!($($arg)*)
    }
}
...
///
#[deprecated(
    note = "Please rename from `assert_program_args_stdout_contains` to `assert_program_args_stdout_string_contains`."
)]
#[macro_export]
...
///
#[deprecated(
    note = "Please rename from `debug_assert_program_args_stdout_contains` to `debug_assert_program_args_stdout_string_contains`."
)]
#[macro_export]
macro_rules! debug_assert_program_args_stdout_contains {
    ($($arg:tt)*) => {
        $crate::debug_assert_program_args_stdout_string_contains!($($arg)*)
    }
}
