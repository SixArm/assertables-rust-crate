...
//! * [`assert_program_args_stdout_ge!(program1, args1, program2, args2)`](macro@crate::assert_program_args_stdout_ge) ≈ command using program1 and args1 to stdout ≥ command2 with program2 and args2 to stdout
//!
...
//! * [`assert_program_args_stderr_ge!(program1, args1, program2, args2)`](macro@crate::assert_program_args_stderr_ge) ≈ command using program1 and args1 to stderr ≥ command2 with program2 and args2 to stderr
//!
