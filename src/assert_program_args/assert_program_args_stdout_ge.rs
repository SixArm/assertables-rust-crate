                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/8.18.0/assertables/macro.assert_program_args_stdout_ge.html\n",
                                        " a_program label: `{}`,\n",
                                        " a_program debug: `{:?}`,\n",
                                        "    a_args label: `{}`,\n",
                                        "    a_args debug: `{:?}`,\n",
...
mod tests {
    ...
    fn test_assert_program_args_stdout_ge_as_result_x_success_because_gt() {
        ...
        let b_args = ["%s%s", "a", "a"];
        let result =
            assert_program_args_stdout_ge_as_result!(&a_program, &a_args, &b_program, &b_args);
        assert_eq!(
            result.unwrap(),
