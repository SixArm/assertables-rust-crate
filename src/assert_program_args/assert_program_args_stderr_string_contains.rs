...
mod tests {
    ...
    fn test_assert_command_stderr_contains_x_success() {
        ...
        let a_args = ["%s", "alfa"];
        let b = "lf";
        let result = assert_program_args_stderr_string_contains_as_result!(&a_program, &a_args, b);
...
/// # });
/// // assertion failed: `assert_program_args_stderr_string_contains!(a_program, a_args, containee)`
/// // https://docs.rs/assertables/8.14.0/assertables/macro.assert_program_args_stderr_string_contains.html
