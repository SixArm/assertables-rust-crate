...
/// * [`assert_fn_err_eq_other_as_result`]
/// * [`debug_assert_fn_err_eq_other`]
///
#[macro_export]
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_err_eq_other_as_result_x_success() {
        let a: i32 = 10;
        let b: i32 = 10;
    ...
    #[test]
    fn test_assert_fn_err_eq_other_as_result_x_failure() {
        let a: i32 = 10;
        let b: i32 = 20;
        let x = assert_fn_err_eq_other_as_result!(example_digit_to_string, a, b);
        assert!(x.is_err());
...
/// // Panic with error message
/// let result = panic::catch_unwind(|| {
/// assert_fn_err_eq_other!(example_digit_to_string, a, b, "message");
/// //-> panic!
/// });
/// assert!(result.is_err());
/// let actual = result.unwrap_err().downcast::<String>().unwrap().to_string();
...
/// Assert a function err() is equal to another.
///
/// This macro provides the same statements as [`assert_fn_err_eq_other`],
...
///
#[macro_export]
macro_rules! debug_assert_fn_err_eq_other {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_fn_err_eq_other!($($arg)*);
        }
    };
}
