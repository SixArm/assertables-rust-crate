...
/// //-> Err("…")
/// // assertable failed: `assertable_fn_le!(fn, left, right)`
/// //    left input: `-2`,
/// //   right input: `1`,
/// //   left output: `2`,
/// //  right output: `1`
/// assert_eq!(x.unwrap_err(), "assertable failed: `assertable_fn_le!(fn, left, right)`\n   left input: `-2`,\n  right input: `1`,\n  left output: `2`,\n right output: `1`".to_string());
/// # }
/// ```
///
...
macro_rules! assertable_fn_le {
    ($function:path, $left:expr, $right:expr $(,)?) => ({
        ...
        if (left <= right) {
            ...
            Err(format!("assertable failed: `assertable_fn_le!(fn, left, right)`\n   left input: `{:?}`,\n  right input: `{:?}`,\n  left output: `{:?}`,\n right output: `{:?}`", $left, $right, left, right))
        }
    });
