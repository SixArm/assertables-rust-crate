...
//! # Module macros
//!
//! * [`assert_fn_ok_le_expr`](macro.assert_fn_ok_le_expr.html)
//! * [`assert_fn_ok_le_expr_as_result`](macro.assert_fn_ok_le_expr_as_result.html)
//! * [`debug_assert_fn_ok_le_expr`](macro.debug_assert_fn_ok_le_expr.html)
...
mod tests {
    ...
    mod assert_fn_ok_le_expr_as_result {
        ...
        mod arity_1 {
            ...
            fn test_lt() {
                let a: i8 = 1;
                let b: i8 = 2;
                let x = assert_fn_ok_le_expr_as_result!(f, a, b);
                assert_eq!(x, Ok(()));
            }
        ...
        mod arity_0 {
            ...
            fn test_lt() {
                let b: i8 = 2;
                let x = assert_fn_ok_le_expr_as_result!(f, b);
                assert_eq!(x, Ok(()));
            }
