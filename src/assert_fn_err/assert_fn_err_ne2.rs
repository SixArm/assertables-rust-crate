...
//! let a: i8 = 10;
//! let b: i8 = 20;
//! assert_fn_err_ne2!(f, a, f, b);
//! # }
//! ```
//!
//! # Module macros
//!
//! * [`assert_fn_err_ne2`](macro@crate::assert_fn_err_ne2)
//! * [`assert_fn_err_ne2_as_result`](macro@crate::assert_fn_err_ne2_as_result)
//! * [`debug_assert_fn_err_ne2`](macro@crate::debug_assert_fn_err_ne2)
...
///
#[macro_export]
macro_rules! assert_fn_err_ne2_as_result {
...
mod tests {
    ...
    mod assert_fn_err_ne2_as_result {
        ...
        mod arity_1 {
            ...
            fn test_ne() {
                let a: i8 = 1;
                let b: i8 = 2;
                let result = assert_fn_err_ne2_as_result!(f, a, g, b);
        ...
        mod arity_0 {
            ...
            #[test]
            fn test_ne() {
                let result = assert_fn_err_ne2_as_result!(f, g);
                assert_eq!(result.unwrap(), (1, 2));
            }

            #[test]
            fn test_eq() {
                let result = assert_fn_err_ne2_as_result!(f, f);
                assert_eq!(
                    result.unwrap_err(),
                    concat!(
                        "assertion failed: `assert_fn_err_ne2!(a_function, b_function)`\n",
...
///
#[macro_export]
macro_rules! assert_fn_err_ne2 {

    //// Arity 1

    ($a_function:path, $a_param:expr, $b_function:path, $b_param:expr $(,)?) => {{
        match $crate::assert_fn_err_ne2_as_result!($a_function, $a_param, $b_function, $b_param) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
    ...
    ($a_function:path, $b_function:path) => {{
        match $crate::assert_fn_err_ne2_as_result!($a_function, $b_function) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
...
/// (a_function(a_param) ⇒ Err(a) ⇒ a) ≤ (b_function(b_param) ⇒ Err(b) ⇒ b)
///
/// This macro provides the same statements as [`assert_fn_err_ne2`](macro.assert_fn_err_ne2.html),
...
///
#[macro_export]
macro_rules! debug_assert_fn_err_ne2 {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_fn_err_ne2!($($arg)*);
        }
    };
}
