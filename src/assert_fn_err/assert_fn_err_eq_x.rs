                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.4.0/assertables/macro.assert_fn_err_eq_x.html\n",
                                        " a_function label: `{}`,\n",
                                        "    a_param label: `{}`,\n",
                                        "    a_param debug: `{:?}`,\n",
                                        "     b_expr label: `{}`,\n",
...
mod tests {
    ...
    mod assert_fn_err_eq_x_as_result {
        ...
        mod arity_1 {
            ...
            fn eq() {
                let a: i8 = 1;
                let b: i8 = 1;
                let result = assert_fn_err_eq_x_as_result!(f, a, b);
        ...
        mod arity_0 {
            ...
            #[test]
            fn eq() {
                let result = assert_fn_err_eq_x_as_result!(f, 1);
                assert_eq!(result.unwrap(), 1);
            }
            ...
            fn test_ne() {
                let b: i8 = 2;
                let result = assert_fn_err_eq_x_as_result!(f, b);
                assert_eq!(
                    result.unwrap_err(),
                    concat!(
                        "assertion failed: `assert_fn_err_eq_x!(a_function, b_expr)`\n",
