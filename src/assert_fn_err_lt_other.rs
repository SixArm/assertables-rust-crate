...
/// * [`assert_fn_err_lt_other_as_result`]
/// * [`debug_assert_fn_err_lt_other`]
///
#[macro_export]
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_err_lt_other_as_result_x_success_because_lt() {
        let a: i32 = 10;
        let b: i32 = 20;
    ...
    #[test]
    fn test_assert_fn_err_lt_other_as_result_x_failure_because_eq() {
        let a: i32 = 10;
        let b: i32 = 10;
        let x = assert_fn_err_lt_other_as_result!(example_digit_to_string, a, b);
        assert!(x.is_err());
    ...
    #[test]
    fn test_assert_fn_err_lt_other_as_result_x_failure_because_gt() {
        let a: i32 = 20;
        let b: i32 = 10;
        let x = assert_fn_err_lt_other_as_result!(example_digit_to_string, a, b);
        assert!(x.is_err());
...
/// // Panic with error message
/// let result = panic::catch_unwind(|| {
/// assert_fn_err_lt_other!(example_digit_to_string, a, b, "message");
/// //-> panic!
/// });
/// assert!(result.is_err());
/// let actual = result.unwrap_err().downcast::<String>().unwrap().to_string();
...
/// Assert a function err() is less than another.
///
/// This macro provides the same statements as [`assert_fn_err_lt_other`],
...
///
#[macro_export]
macro_rules! debug_assert_fn_err_lt_other {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_fn_err_lt_other!($($arg)*);
        }
    };
}
