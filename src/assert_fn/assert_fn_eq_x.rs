                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.4.0/assertables/macro.assert_fn_eq_x.html\n",
                                " a_function label: `{}`,\n",
                                "    a_param label: `{}`,\n",
                                "    a_param debug: `{:?}`,\n",
                                "     b_expr label: `{}`,\n",
    ...
    mod assert_fn_eq_x_as_result {
        ...
        mod arity_1 {
            ...
            fn eq() {
                let a: i8 = 1;
                let b: i8 = 1;
                let result = assert_fn_eq_x_as_result!(f, a, b);
                assert_eq!(result.unwrap(), 1);
            }

            #[test]
            fn test_assert_fn_eq_x_expr_as_result_x_arity_1_x_failure() {
                let a: i8 = 1;
                let b: i8 = 2;
                let result = assert_fn_eq_x_as_result!(f, a, b);
                assert_eq!(
        ...
        mod arity_0 {
            ...
            fn eq() {
                let b: i8 = 1;
                let result = assert_fn_eq_x_as_result!(f, b);
                assert_eq!(result.unwrap(), 1);
            }
