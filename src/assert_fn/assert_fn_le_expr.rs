...
//! # Module macros
//!
//! * [`assert_fn_le_expr`](macro@crate::assert_fn_le_expr)
//! * [`assert_fn_le_expr_as_result`](macro@crate::assert_fn_le_expr_as_result)
                ...
                if a_output <= $b_expr {
                    ...
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_fn_le_expr.html\n",
                            " a_function label: `{}`,\n",
                            "    a_param label: `{}`,\n",
                            "    a_param debug: `{:?}`,\n",
                            "     b_expr label: `{}`,\n",
...
/// # });
/// // assertion failed: `assert_fn_le_expr!(a_function, a_param, b_expr)`
/// // https://docs.rs/assertables/8.18.0/assertables/macro.assert_fn_le_expr.html
