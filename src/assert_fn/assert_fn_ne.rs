                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.1.0/assertables/macro.assert_fn_ne.html\n",
                                " a_function label: `{}`,\n",
                                "    a_param label: `{}`,\n",
                                "    a_param debug: `{:?}`,\n",
                                " b_function label: `{}`,\n",
...
mod tests {
    ...
    mod assert_fn_ne_as_result {
        ...
        mod arity_0 {
            ...
            #[test]
            fn test_ne() {
                let result = assert_fn_ne_as_result!(f, g);
                assert_eq!(result.unwrap(), (1, 2));
            }

            #[test]
            fn eq() {
                let result = assert_fn_ne_as_result!(f, f);
                assert_eq!(
                    result.unwrap_err(),
                    concat!(
                        "assertion failed: `assert_fn_ne!(a_function, b_function)`\n",
        ...
        mod arity_1 {
            ...
            fn test_ne() {
                let a: i8 = 1;
                let b: i8 = 2;
                let result = assert_fn_ne_as_result!(f, a, g, b);
                assert_eq!(result.unwrap(), (1, 2));
            }

            #[test]
            fn test_assert_fn_ne_as_result_arity_1_x_failure() {
                let a: i8 = 1;
                let b: i8 = 1;
                let result = assert_fn_ne_as_result!(f, a, g, b);
                assert_eq!(
