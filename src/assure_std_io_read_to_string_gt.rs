/// Assure a std::io::Read read_to_string() value is greater than anoter.
///
...
mod tests {
    ...
    #[test]
    fn test_assert_assure_std_io_read_to_string_gt_x_arity_3_success() {
        let mut a = "a".as_bytes();
        let mut b = "b".as_bytes();
    ...
    #[test]
    fn test_assert_assure_std_io_read_to_string_gt_x_arity_3_failure() {
        let mut a = "a".as_bytes();
        let mut b = "b".as_bytes();
