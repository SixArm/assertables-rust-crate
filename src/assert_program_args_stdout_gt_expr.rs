...
/// # Module macros
///
/// * [`assert_program_args_stdout_gt_expr`](macro.assert_program_args_stdout_gt_expr.html)
/// * [`assert_program_args_stdout_gt_expr_as_result`](macro.assert_program_args_stdout_gt_expr_as_result.html)
/// * [`debug_assert_program_args_stdout_gt_expr`](macro.debug_assert_program_args_stdout_gt_expr.html)
///
#[macro_export]
...
mod tests {
    ...
    fn test_assert_program_args_stdout_gt_expr_as_result_x_success() {
        ...
        let x = assert_program_args_stdout_gt_expr_as_result!(&a_program, &a_args, b);
        assert_eq!(x.unwrap(), ());
    }
...
/// Assert a command (built with program and args) stdout string is greater than an expression.
///
/// This macro provides the same statements as [`assert_program_args_stdout_gt_expr`],
