...
mod tests {
    ...
    #[test]
    fn test_assume_io_eq_x_arity_2_success() {
        let a = 1;
        let b = 1;
        let x = assume_io_eq!(a, b);
        assert_eq!(
            x.unwrap(),
            true
        );
    ...
    #[test]
    fn test_assume_io_eq_x_arity_2_failure() {
        let a = 1;
        let b = 2;
        let x = assume_io_eq!(a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assume_io_eq_x_arity_3_success() {
        let a = 1;
        let b = 1;
        let x = assume_io_eq!(a, b, "message");
        assert_eq!(
            x.unwrap(),
            true
        );
    ...
    #[test]
    fn test_assume_io_eq_x_arity_3_failure() {
        let a = 1;
        let b = 2;
        let x = assume_io_eq!(a, b, "message");
        assert_eq!(
