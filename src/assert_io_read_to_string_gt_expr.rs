...
//! # Module macros
//!
//! * [`assert_io_read_to_string_gt_expr`](macro.assert_io_read_to_string_gt_expr.html)
//! * [`assert_io_read_to_string_gt_expr_as_result`](macro.assert_io_read_to_string_gt_expr_as_result.html)
//! * [`debug_assert_io_read_to_string_gt_expr`](macro.debug_assert_io_read_to_string_gt_expr.html)
