...
/// let expect = concat!(
///     "assertion failed: `assert_fn_ok_gt_other!(pair_function, left_input, right_input)`\n",
...
/// * [`assert_fn_ok_gt_other_as_result`]
/// * [`debug_assert_fn_ok_gt_other`]
///
#[macro_export]
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_ok_gt_other_as_result_x_success_because_gt() {
        let a: i32 = 2;
        let b: i32 = 1;
        let x = assert_fn_ok_gt_other_as_result!(example_digit_to_string, a, b);
        assert!(x.is_ok());
    ...
    #[test]
    fn test_assert_fn_ok_gt_other_as_result_x_failure_because_eq() {
        let a: i32 = 1;
        let b: i32 = 1;
        let x = assert_fn_ok_gt_other_as_result!(example_digit_to_string, a, b);
        assert!(x.is_err());
    ...
    #[test]
    fn test_assert_fn_ok_gt_other_as_result_x_failure_because_lt() {
        let a: i32 = 1;
        let b: i32 = 2;
        let x = assert_fn_ok_gt_other_as_result!(example_digit_to_string, a, b);
        assert!(x.is_err());
...
/// Assert a function ok() is greater than another.
///
/// This macro provides the same statements as [`assert_fn_ok_gt_other`],
...
/// 
#[macro_export]
macro_rules! debug_assert_fn_ok_gt_other {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_fn_ok_gt_other!($($arg)*);
        }
    };
}
