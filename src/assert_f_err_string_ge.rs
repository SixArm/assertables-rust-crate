...
/// # let expect = "assertion failed: `assert_f_err_string_ge!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `20`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"20 is out of range\"`";
...
mod tests {
    ...
    fn test_assert_f_err_string_ge_x_arity_2_gt_success() {
        let a = 20;
        let b = 10;
        let x = assert_f_err_string_ge!(example_digit_to_string, a, b);
        assert_eq!(x, ());
    }
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_f_err_string_ge!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `10`,\n  right input: `20`,\n  left is err: `true`,\n right is err: `true`,\n  left output: `\"10 is out of range\"`,\n right output: `\"20 is out of range\"`")]
    fn test_assert_f_err_string_ge_x_arity_2_lt_failure() {
        let a = 10;
        let b = 20;
        let _x = assert_f_err_string_ge!(example_digit_to_string, a, b);
    }
    ...
    fn test_assert_f_err_string_ge_x_arity_3_gt_success_gt() {
        let a = 20;
        let b = 10;
        let x = assert_f_err_string_ge!(example_digit_to_string, a, b, "message");
        assert_eq!(x, ());
    }
    ...
    fn test_assert_f_err_string_ge_x_arity_3_failure() {
        let a = 10;
        let b = 20;
        let _x = assert_f_err_string_ge!(example_digit_to_string, a, b, "message");
    }
