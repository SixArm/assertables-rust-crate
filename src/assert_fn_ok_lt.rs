...
/// //-> panic!
/// // assertion failed: `assert_fn_ok_lt!(fn, left, right)`
/// //    left input: `\"2\"`,
/// //   right input: `\"1\"`,
/// //   left output: `2`,
/// //  right output: `1`
...
/// # let expect = "assertion failed: `assert_fn_ok_lt!(fn, left, right)`\n   left input: `\"2\"`,\n  right input: `\"1\"`,\n  left output: `2`,\n right output: `1`";
...
mod tests {
    ...
    fn test_assert_fn_ok_lt_x_arity_2_eq_failure() {
        let a = "1";
        let b = "1";
        let _x = assert_fn_ok_lt!(i32::from_str, a, b);
    }
    ...
    fn test_assert_fn_ok_lt_x_arity_3_eq_failure() {
        let a = "1";
        let b = "1";
        let _x = assert_fn_ok_lt!(i32::from_str, a, b, "message");
    }
