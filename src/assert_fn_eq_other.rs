...
/// let expect = concat!(
///     "assertion failed: `assert_fn_eq_other!(function, left_input, right_input)`\n",
...
///
#[macro_export]
macro_rules! assert_fn_eq_other_as_result {
...
///
#[macro_export]
macro_rules! assert_fn_eq_other {
    ($function:path, $a_input:expr, $b_input:expr $(,)?) => ({
...
mod test_x_panic {
    ...
    fn test_assert_fn_eq_x_arity_2_eq_success() {
        let a: i32 = 1;
        let b: i32 = -1;
        let x = assert_fn_eq_other!(i32::abs, a, b);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_eq_other!(function, left_input, right_input)`\n    function name: `i32::abs`,\n  left input name: `a`,\n right input name: `b`,\n       left input: `1`,\n      right input: `-2`,\n      left output: `1`,\n     right output: `2`")]
    fn test_assert_fn_eq_x_arity_2_ne_failure() {
        let a: i32 = 1;
        let b: i32 = -2;
        let _x = assert_fn_eq_other!(i32::abs, a, b);
    }
    ...
    fn test_assert_fn_eq_x_arity_3_eq_success() {
        let a: i32 = 1;
        let b: i32 = -1;
        let x = assert_fn_eq_other!(i32::abs, a, b, "message");
        assert_eq!(x, ());
    }
    ...
    fn test_assert_fn_eq_x_arity_3_ne_failure() {
        let a: i32 = 1;
        let b: i32 = -2;
        let _x = assert_fn_eq_other!(i32::abs, a, b, "message");
    }
