...
///
/// * [`assert_fn_eq_other`]
/// * [`assert_fn_eq_other_as_result`]
/// * [`debug_assert_fn_eq_other`]
///
#[macro_export]
...
/// Assert a function output is equal to another function output.
///
/// This macro provides the same statements as [`assert_fn_eq_other`],
...
///
#[macro_export]
macro_rules! debug_assert_fn_eq_other {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_fn_eq_other!($($arg)*);
        }
    };
}
