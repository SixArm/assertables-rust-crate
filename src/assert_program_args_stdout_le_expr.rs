...
/// * [`assert_program_args_stdout_le_expr_as_result`]
/// * [`debug_assert_program_args_stdout_le_expr`]
///
#[macro_export]
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_program_args_stdout_le_expr_as_result_x_success() {
    ...
    #[test]
    fn test_assert_program_args_stdout_le_expr_as_result_x_failure() {
        let a_program = "printf";
        let a_args = ["%s", "alpha"];
        let b = "bravo";
        let x = assert_program_args_stdout_le_expr_as_result!(&a_program, &a_args, b);
