...
mod test_x_panic {
    ...
    #[test]
    fn test_assert_fn_err_le_other_x_arity_2_lt_success() {
        let a: i32 = 10;
        let b: i32 = 20;
        let x = assert_fn_err_le_other!(example_digit_to_string, a, b);
        assert_eq!(x, ());
    }

    #[test]
    fn test_assert_fn_err_le_other_x_arity_2_eq_success() {
        let a: i32 = 10;
        let b: i32 = 10;
        let x = assert_fn_err_le_other!(example_digit_to_string, a, b);
        assert_eq!(x, ());
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_err_le_other!(function, left_input, right_input)`\n    function name: `example_digit_to_string`,\n  left input name: `a`,\n right input name: `b`,\n       left input: `20`,\n      right input: `10`,\n      left output: `\"20 is out of range\"`,\n     right output: `\"10 is out of range\"`")]
    fn test_assert_fn_err_le_other_x_arity_2_gt_failure() {
        let a: i32 = 20;
        let b: i32 = 10;
        let _x = assert_fn_err_le_other!(example_digit_to_string, a, b);
    }
}
