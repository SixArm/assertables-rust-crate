...
mod test_x_panic {
    ...
    #[test]
    fn test_assert_read_to_string_le_other_x_arity_2_success() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let x = assert_read_to_string_le_other!(a, b);
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "assertion failed: `assert_read_to_string_le_other!(left_reader, right_reader)`\n  left reader name: `a`,\n right reader name: `b`,\n  left reader size: `5`,\n right reader size: `5`,\n  left reader data: `\"bravo\"`,\n right reader data: `\"alpha\"`")]
    fn test_assert_read_to_string_le_other_x_arity_2_failure() {
        let mut a = "bravo".as_bytes();
        let mut b = "alpha".as_bytes();
        let _x = assert_read_to_string_le_other!(a, b);
    }

    #[test]
    fn test_assert_read_to_string_le_other_x_arity_3_success() {
        let mut a = "alpha".as_bytes();
        let mut b = "bravo".as_bytes();
        let x = assert_read_to_string_le_other!(a, b, "message");
        assert_eq!(x, ());
    }

    #[test]
    #[should_panic (expected = "message")]
    fn test_assert_read_to_string_le_other_x_arity_3_failure() {
        let mut a = "bravo".as_bytes();
        let mut b = "alpha".as_bytes();
        let _x = assert_read_to_string_le_other!(a, b, "message");
    }
