...
/// Assert a std::io::Read read_to_string() value is less than or equal to another.
///
/// This macro provides the same statements as [`assert_read_to_string_le_other`],
...
///
#[macro_export]
macro_rules! debug_assert_read_to_string_le_other {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_read_to_string_le_other!($($arg)*);
        }
    };
}
