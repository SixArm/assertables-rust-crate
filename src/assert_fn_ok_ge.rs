...
/// let expect = concat!(
///     "assertion failed: `assert_fn_ok_ge!(function, left_input, right_expr)`\n",
...
mod test_x_result {
    ...
    #[test]
    fn test_assert_fn_ok_ge_as_result_x_arity_2_gt_success() {
        let a: i32 = 2;
        let b = String::from("1");
        let x = assert_fn_ok_ge_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_ok_ge_as_result_x_arity_2_eq_success() {
        let a: i32 = 1;
        let b = String::from("1");
        let x = assert_fn_ok_ge_as_result!(example_digit_to_string, a, b);
        assert_eq!(
    ...
    #[test]
    fn test_assert_fn_ok_ge_as_result_x_arity_2_lt_failure() {
        let a: i32 = 1;
        let b = String::from("2");
        let x = assert_fn_ok_ge_as_result!(example_digit_to_string, a, b);
        assert_eq!(
...
macro_rules! assert_fn_ok_ge {
    ($function:path, $a_input:expr, $b_expr:expr $(,)?) => ({
        match assert_fn_ok_ge_as_result!($function, $a_input, $b_expr) {
            Ok(()) => (),
            Err(err) => panic!("{}", err),
        }
    });
...
mod test_x_panic {
    ...
    fn test_assert_fn_ok_ge_x_arity_2_gt_success() {
        let a: i32 = 2;
        let b = String::from("1");
        let x = assert_fn_ok_ge!(example_digit_to_string, a, b);
        assert_eq!(x, ());
    }
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_ok_ge!(function, left_input, right_expr)`\n    function name: `example_digit_to_string`,\n  left input name: `a`,\n  right expr name: `b`,\n       left input: `1`,\n       right expr: `\"2\"`,\n      left output: `\"1\"`,\n             left: `\"1\"`,\n            right: `\"2\"`")]
    fn test_assert_fn_ok_ge_x_arity_2_lt_failure() {
        let a: i32 = 1;
        let b = String::from("2");
        let _x = assert_fn_ok_ge!(example_digit_to_string, a, b);
    }
    ...
    fn test_assert_fn_ok_ge_x_arity_3_gt_success_gt() {
        let a: i32 = 2;
        let b = String::from("1");
        let x = assert_fn_ok_ge!(example_digit_to_string, a, b, "message");
        assert_eq!(x, ());
    }
    ...
    fn test_assert_fn_ok_ge_x_arity_3_failure() {
        let a: i32 = 1;
        let b = String::from("2");
        let _x = assert_fn_ok_ge!(example_digit_to_string, a, b, "message");
    }
