...
///
/// # fn main() {
/// assert_fn_ok_ge!(example_digit_to_string, 2, 1);
/// //-> ()
///
/// # let result = panic::catch_unwind(|| {
/// assert_fn_ok_ge!(example_digit_to_string, 1, 2);
/// //-> panic!("…")
/// // assertion failed: `assert_fn_ok_ge!(function, left, right)`
...
/// # let expect = "assertion failed: `assert_fn_ok_ge!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `1`,\n  right input: `2`,\n  left output: `\"1\"`,\n right output: `\"2\"`";
...
mod tests {
    ...
    #[test]
    #[should_panic (expected = "assertion failed: `assert_fn_ok_ge!(function, left, right)`\n     function: `\"example_digit_to_string\"`,\n   left input: `1`,\n  right input: `2`,\n  left output: `\"1\"`,\n right output: `\"2\"`")]
