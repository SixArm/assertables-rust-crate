...
//! # Module macros
//!
//! * [`assert_io_read_to_string_eq_expr`](macro@crate::assert_io_read_to_string_eq_expr)
//! * [`assert_io_read_to_string_eq_expr_as_result`](macro@crate::assert_io_read_to_string_eq_expr_as_result)
//! * [`debug_assert_io_read_to_string_eq_expr`](macro@crate::debug_assert_io_read_to_string_eq_expr)
                ...
                if let Err(a_err) = a_result {
                    Err(format!(
                        concat!(
                            ...
                            "https://docs.rs/assertables/", env!("CARGO_PKG_VERSION"), "/assertables/macro.assert_io_read_to_string_eq_expr.html\n",
                            " a_reader label: `{}`,\n",
                            " a_reader debug: `{:?}`,\n",
                            "   b_expr label: `{}`,\n",
                            "   b_expr debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_io_read_to_string_eq_expr_as_result_x_success() {
        let mut reader = "alfa".as_bytes();
        let value = String::from("alfa");
        let result = assert_io_read_to_string_eq_expr_as_result!(reader, &value);
        assert_eq!(result, Ok(()));
    }

    #[test]
    fn test_assert_io_read_to_string_eq_expr_as_result_x_failure() {
        let mut reader = "alfa".as_bytes();
...
/// # });
/// // assertion failed: `assert_io_read_to_string_eq_expr!(a_reader, b_expr)`
/// // https://docs.rs/assertables/8.17.0/assertables/macro.assert_io_read_to_string_eq_expr.html
/// //  a_reader label: `reader`,
/// //  a_reader debug: `[]`,
/// //    b_expr label: `&value`,
/// //    b_expr debug: `\"bravo\"`,
...
macro_rules! debug_assert_io_read_to_string_eq_expr {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_io_read_to_string_eq_expr!($($arg)*);
        }
    };
}
