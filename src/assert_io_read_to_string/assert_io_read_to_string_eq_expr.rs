                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.0.0/assertables/macro.assert_io_read_to_string_eq_expr.html\n",
                                        " a_reader label: `{}`,\n",
                                        " a_reader debug: `{:?}`,\n",
                                        "   b_expr label: `{}`,\n",
                                        "   b_expr debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_io_read_to_string_eq_expr_as_result_x_success_because_eq() {
        let mut reader = "alfa".as_bytes();
        let value = String::from("alfa");
    ...
    #[test]
    fn test_assert_io_read_to_string_eq_expr_as_result_x_failure_because_lt() {
        let mut reader = "alfa".as_bytes();
    ...
    #[test]
    fn test_assert_io_read_to_string_eq_expr_as_result_x_failure_because_gt() {
