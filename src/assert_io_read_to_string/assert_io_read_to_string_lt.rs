                    ...
                    Err(
                        format!(
                            concat!(
                                ...
                                "https://docs.rs/assertables/9.4.0/assertables/macro.assert_io_read_to_string_lt.html\n",
                                " a label: `{}`,\n",
                                " a debug: `{:?}`,\n",
                                " b label: `{}`,\n",
                                " b debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_io_read_to_string_lt_as_result_success() {
        let mut a = "alfa".as_bytes();
        let mut b = "bravo".as_bytes();
    ...
    #[test]
    fn test_assert_io_read_to_string_lt_as_result_failure() {
