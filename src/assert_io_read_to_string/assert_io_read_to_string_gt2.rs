...
//! assert_io_read_to_string_gt2!(b, a);
//! # }
//! ```
//!
//! # Module macros
//!
//! * [`assert_io_read_to_string_gt2`](macro@crate::assert_io_read_to_string_gt2)
//! * [`assert_io_read_to_string_gt2_as_result`](macro@crate::assert_io_read_to_string_gt2_as_result)
//! * [`debug_assert_io_read_to_string_gt2`](macro@crate::debug_assert_io_read_to_string_gt2)
...
///
#[macro_export]
macro_rules! assert_io_read_to_string_gt2_as_result {
            ...
            (Ok(_a_size), Ok(_b_size)) => {
                if a_string > b_string {
                    ...
                    Err(
                        format!(
                            concat!(
                                "assertion failed: `assert_io_read_to_string_gt2!(a_reader, b_reader)`\n",
                                "https://docs.rs/assertables/9.0.0/assertables/macro.assert_io_read_to_string_gt2.html\n",
                                " a label: `{}`,\n",
                                " a debug: `{:?}`,\n",
                                " b label: `{}`,\n",
                                " b debug: `{:?}`,\n",
...
/// let mut a = "alfa".as_bytes();
/// let mut b = "bravo".as_bytes();
/// assert_io_read_to_string_gt2!(a, b);
/// # });
/// // assertion failed: `assert_io_read_to_string_gt2!(a_reader, b_reader)`
/// // https://docs.rs/assertables/9.0.0/assertables/macro.assert_io_read_to_string_gt2.html
/// //  a label: `a`,
...
///
#[macro_export]
macro_rules! assert_io_read_to_string_gt2 {
    ($a_reader:expr, $b:expr $(,)?) => {{
        match $crate::assert_io_read_to_string_gt2_as_result!($a_reader, $b) {
            Ok(x) => x,
            Err(err) => panic!("{}", err),
        }
    }};
...
/// (a_reader.read_to_string(a_string) ⇒ a_string) > (b_reader.read_to_string(b_string) ⇒ b_string)
///
/// This macro provides the same statements as [`assert_io_read_to_string_gt2`](macro.assert_io_read_to_string_gt2.html),
...
///
#[macro_export]
macro_rules! debug_assert_io_read_to_string_gt2 {
    ($($arg:tt)*) => {
        if $crate::cfg!(debug_assertions) {
            $crate::assert_io_read_to_string_gt2!($($arg)*);
        }
    };
}
