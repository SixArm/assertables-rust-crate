                            ...
                            Err(
                                format!(
                                    concat!(
                                        ...
                                        "https://docs.rs/assertables/9.1.0/assertables/macro.assert_io_read_to_string_lt_x.html\n",
                                        " a_reader label: `{}`,\n",
                                        " a_reader debug: `{:?}`,\n",
                                        "   b_expr label: `{}`,\n",
                                        "   b_expr debug: `{:?}`,\n",
...
mod tests {
    ...
    #[test]
    fn test_assert_io_read_to_string_lt_x_expr_as_result_x_success() {
        let mut reader = "alfa".as_bytes();
        let value = String::from("bravo");
        let result = assert_io_read_to_string_lt_x_as_result!(reader, &value);
        assert_eq!(result.unwrap(), String::from("alfa"));
    }

    #[test]
    fn test_assert_io_read_to_string_lt_x_expr_as_result_x_failure() {
